...
function playerEntry(eim, player) {
    eim.startEventTimer(1800000);//啟動30分鐘的倒計時
    var map = eim.getMapInstance(0);//超時觸發end(eim)
    player.setDeathCount(10);//設置玩家死亡次數（10次）
    player.changeMap(map, map.getPortal(0));//傳送至副本起始地圖
}
