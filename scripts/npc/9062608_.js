...
function action(mode, type, selection) {
    if (mode == -1 || mode == 0) {
        if (status == 2 && sel == 4) {//승급 거부
            cm.sendOkS("#fs11#그래! 마음이 바뀌면 다시 돌아오게나!", 0x04, 9062605);
        }
        cm.dispose();
        return;
    }
    ...
    if (status == 0) {
        ...
        var choose = "#fn나눔고딕#PRAY 컨텐츠시스템 입니다.#fs13##k\r\n";
		choose += "#fn나눔고딕#각종 컨텐츠들과 함께 즐거운 PRAY되세요!#fs11##k\r\n";
		choose += "\r\n\r\n"+ 연보 + "───────────────────────────#k\r\n";
        choose += "#L1#" + 뎀스 + " #fc0xFF6799FF#일일 퀘스트#l　";
		//choose += "#L5#" + 뎀스 + " #fc0xFF6799FF#요일 퀘스트#l　";
		choose += "#L17#" + 뎀스 + " #fc0xFF6799FF#파티 퀘스트#l";choose += "#L2#" + 뎀스 + " #fc0xFF6799FF#안개 숲 수련장#l\r\n\r\n";
        choose += "#fc0xFFD5D5D5#"+ 연보 + "───────────────────────────#k\r\n";
                        //choose += "#L44#" + 집 + " #fc0xFF0054FF#초기화보상#l\r\n\r\n";
        ...
        //choose += "#L20#" + 집 + " #fc0xFFFFA648#제작 및 강화시스템#l";choose += "#L16#" + 집 + " #fc0xFFFFA648#제네시스제작#l";
        //choose += "\r\n\r\n#fc0xFFD5D5D5#"+ 연보 + "───────────────────────────#k\r\n";
        choose += "#L22#" + 집 + " #fc0xFF0054FF#길드 업무#l"; 
		choose += "#L24#" + 집 + " #fc0xFF0054FF#무릉도장#l";
        choose += "\r\n\r\n#fc0xFFD5D5D5#"+ 연보 + "───────────────────────────#k\r\n";
        //choose += "#L2#" + 뎀스 + " #fc0xFF6799FF#안개 숲 수련장#l";
		//choose += "#L18#" + 컨텐츠 + " #fc0xFF6799FF#메소강화#l";
		choose += "#L21##fc0xFF6B66FF#" + 펫 + " 일반 펫 분양소#l";
        choose += "\r\n\r\n#fc0xFFD5D5D5#"+ 연보 + "───────────────────────────#k\r\n";
        //choose += "#L20#" + 집 + " #fc0xFFFFA648#기본악세제작#l";choose += "#L19#" + 집 + " #fc0xFFFFA648#초월파프제작#l\r\n\r\n";choose += "#L16#" + 집 + " #fc0xFFFFA648#제네시스제작#l\r\n\r\n";
      ...
      var choose = "#fs11#" + 검정 + "일일 퀘스트를 진행하시겠어요??\r\n";
		...
		if(cm.getPlayer().getAllUnion() < 8000) {
		 ...
		 cm.openNpcCustom(cm.getClient(), 1052206, "DailyQuest");
            ...
            cm.dispose();
            cm.openNpc(9062605, "초기화보상");
        } else if (selection == 19) {
            cm.dispose();
            cm.openNpc(9062605, "MakeItem");
        } else if (selection == 20) {
            cm.dispose();
            cm.openNpc(2200004, "2200004");
