...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var msg = "#fs11#\r\n";
        var chat = enter
        var msg = "#fs11##r어서오세요 #h0#님! 무엇을 강화하시겠어요?\r\n";
     //   msg += "#L1004#[프레이] 커스텀 제작\r\n\r\n#l"
        //msg += "#L1000##b[프레이] 커스텀 1기 제작 \r\n\r\n#l"
        msg += "#L2001##b[프레이] 커스텀 2기 제작 \r\n\r\n#l"
        //msg += "#L1004#[프레이] 커스텀 3기 제작\r\n\r\n#l"
        // msg += "#L1001#칠요의 몬스터파커 훈장 제작\r\n#l"
        //msg += "#L1002#[프레이] 칭호를 승급하고 싶어요.\r\n#l"
        msg += "#L2000#[프레이] 커스텀 3기 제작\r\n\r\n"
        msg += "#L1003#[프레이] 커스텀 4기 제작\r\n\r\n#l"
     //   msg += "#L1005#[프레이] 커스텀 5기 제작\r\n\r\n#l"
    //    msg += "#L1010#[프레이] 커스텀 6기 제작\r\n\r\n#l"
    //    msg += "#L1006#[프레이] 커스텀 7기 제작\r\n#l"
        ...
        if (selection == 0) {
            ...
            cm.dispose();
            cm.openNpc(9010057); //스탯강화 	
        } else if (selection == 1001) {
            cm.dispose();
            cm.openNpc(9010057); //칠요 훈장
        } else if (selection == 1002) {
            cm.dispose();
            cm.openNpc(9062326); //환불 교환	
        } else if (selection == 1003) {
            cm.dispose();
            cm.openNpc(9062326); //환불 교환	
        } else if (selection == 1004) {
            cm.dispose();
            cm.openNpc(1061006); //커스텀제작	
        } else if (selection == 1005) {
            cm.dispose();
            cm.openNpc(9062327); //커스텀 1기
        } else if (selection == 1000) {
            cm.dispose();
            cm.openNpc(3004062); //장비승급
        } else if (selection == 1006) {
            cm.dispose();
            cm.openNpc(2220004); //장비승급
        } else if (selection == 1010) {
            cm.dispose();
            cm.openNpc(3004062); //장비승급
        } else if (selection == 1007) {
            cm.dispose();
            cm.openNpc(1052210); //커스텀 3기
        } else if (selection == 2000) {
            cm.dispose();
            cm.openNpc(9062324); //커스텀 2기
        } else if (selection == 2001) {
            cm.dispose();
            cm.openNpc(9062325); //3차
        }
    } else if (status == 2) {
        sell = selection;
        if (sel == 4) { // 칭호 승급
