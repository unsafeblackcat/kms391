...
function action(mode, type, selection)
{
   ...
   if (status == 0) {
      var msg = "\r\n#fc0xFF000000##fs15#다양한 해외의 헤어와 성형을 체험해봐!\r\n\r\n";
      ...
      codyList = [];
      gColor = !cm.getPlayer().getGender() ? "#fs15##d여성" : "#fs15##b남성";
      seld = selection;
      selStr = "#fs15##fc0xFF000000#원하는 리스트를 골라봐";
      switch (seld) {
         case 1:
            selStr += "\r\n\r\n#e#r[캐릭터 헤어 변경하기]#b#n\r\n";
            selStr += "#L1##fs15##e해외 헤어#n 리스트 A#l#L2# #e해외 헤어#n 리스트 B#l\r\n";
		if (cm.getPlayer().getAndroid() != null) {
            		
            //selStr += "\r\n\r\n#e#r#fs15#[안드로이드 헤어 변경하기]#k#b#n\r\n";
            //selStr += "#L12##fs15##e해외 헤어#n 리스트 A#l#L13# #e해외 헤어#n 헤어 리스트 B#l\r\n";
         ...
         case 2:
            selStr += "\r\n\r\n#e#r[캐릭터 성형]#b#n\r\n";
            selStr += "#e #n#L5##fs15# #e해외 성형#n 리스트 A#l#L6# #e해외 성형#n 리스트 B#k#l\r\n";
		if (cm.getPlayer().getAndroid() != null) {
