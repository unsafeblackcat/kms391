...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		var chat = "#fs15#환생 시스템 입니다. 환생은 시즌 당 최대 #b" + maxReborn + "회 #k까지 가능합니다.\r\n";
		...
		chat += "                     #d#fs15#환생 횟수 : #r" + cm.getPlayer().getKeyValue(7777778, "Reborn") + "회#r/" + maxReborn + "회\r\n";
		chat += "                 #d환생 포인트#r : " + cm.getPlayer().getKeyValue(7777778, "Reborn Point") + "P\r\n";
		chat += "#fs15##L0##b환생 하기#k#l\r\n";
		...
		if (sel == 0) {
			...
			var chat = "#fs15#환생포인트로 아이템을 구매 하실 수 있습니다.\r\n\r\n";
			chat += "#fs15##b보유 환생 포인트 : " + cm.getPlayer().getKeyValue(7777778, "Reborn Point") + "P\r\n\r\n";
