...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var msg = "#e#b아이리스 [아스칼론 악세서리 지급]#k#n\r\n\r\n#r지급받으실 아스칼론 악세서리를 선택해주세요.#k"+enter;
		...
		seld = sel;
		selditem = items[seld];
		var msg = "#e#r[선택하신 악세서리의 정보입니다.]#n#k"+enter;
