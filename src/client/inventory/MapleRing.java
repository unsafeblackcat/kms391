...
public class MapleRing implements Serializable {
	...
	public static MapleRing loadFromDb(long ringId, boolean equipped) {
		...
		try {
			...
			MapleRing ret = null;
			if (rs.next()) {
				ret = new MapleRing(ringId, rs.getLong("partnerRingId"), rs.getInt("partnerChrId"), rs.getInt("itemid"),
	...
	public static void addToDB(int itemid, MapleCharacter chr, String player, int id, long[] ringId)
			throws SQLException {
		Connection con = null;
		PreparedStatement ps = null;
		try {
