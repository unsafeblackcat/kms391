	...
	if (status == 0) {
		...
		selStr += "#fs11##fc0xFF000000#[#e#rHARD#k#l]#k\r\n";
                      ...
                      //  selStr += "#L17##fc0xFF6799FF#Lv.0#d | "+arcaneImg+" 0  | 우르스#l";
                        ...
                        selStr += "#L22##fc0xFF6799FF#Lv.260#d | "+starImg+" 200  | 세렌#l\r\n";
						selStr += "#L23##fc0xFF6799FF#Lv.265#d | "+starImg+" 250  | 칼로스#l\r\n";
						selStr += "#L24##fc0xFF6799FF#Lv.275#d | "+starImg+" 330  | 카링#l\r\n\r\n";
		/*selStr += "#fs11##fc0xFF000000#[#e#r해외보스#k#l]#k\r\n";
						selStr += "#L24##fc0xFF6799FF#Lv.299#d | "+starImg+" 0  | 텐구#l\r\n";
						selStr += "#L25##fc0xFF6799FF#Lv.299#d | "+starImg+" 0  | 미츠히데#l\r\n";
						selStr += "#L26##fc0xFF6799FF#Lv.299#d | "+starImg+" 0  | 진격의 거인#l\r\n";		
						selStr += "#L27##fc0xFF6799FF#Lv.299#d | "+starImg+" 0  | 아우프헤벤#l\r\n";
						selStr += "#L28##fc0xFF6799FF#Lv.299#d | "+starImg+" 0  | 노히메#l\r\n";
						selStr += "#L29##fc0xFF6799FF#Lv.299#d | "+starImg+" 0  | 모리 란마루#l\r\n";*/							
	 ...
	 } else if(status == 1)
	{
		ans_02 = selection;
			switch (ans_02) {
				...
				case 3:
					cm.dispose();
					cm.warpParty(240050400, 0);
					return;
				break;
				case 4:
					cm.dispose();
					cm.warpParty(262030000, 0);
					return;
				break;
				case 5:
					cm.dispose();
				...
				case 23:
					cm.dispose();
					cm.warpParty(410005005, 0);
					return;
				break;
				case 24:
					cm.dispose();
					cm.warpParty(410007025, 0);
					return;
				break;
				case 25:
					cm.dispose();
