	...
	public void dumpMobSkills() throws Exception {
		if (!this.hadError) {
			PreparedStatement ps = this.con.prepareStatement(
					"INSERT INTO wz_mobskilldata(skillid, `level`, hp, mpcon, x, y, time, prop, `limit`, spawneffect,`interval`, ismobgroup, summons, ltx, lty, rbx, rby, once, otherSkillID, otherSkillLev, skillAfter, forced) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
			try {
				dumpMobSkills(ps);
			} catch (Exception e) {
