...
public class MapleReactorFactory {
	...
	private static final MapleDataProvider data = MapleDataProviderFactory
			.getDataProvider(new File(System.getProperty("wz") + "/Reactor.wz"));
			...
			if (stats == null) {
				...
				for (i = 0;; i = (byte) (i + 1)) {
					...
					if (reactorInfoData_ != null && reactorInfoData_.getChildByPath("0") != null) {
						...
						if (type == 100) {
							reactItem = new Pair<>(Integer.valueOf(MapleDataTool.getIntConvert("0", reactorInfoData)),
									Integer.valueOf(MapleDataTool.getIntConvert("1", reactorInfoData, 1)));
							if (!areaSet) {
