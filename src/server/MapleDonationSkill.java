...
public enum MapleDonationSkill { // 가
	HOLY_SYMBOL(0x01, 2311003), WIND_BOOSTER(0x02, 5121009), SHARP_EYES(0x04, 3121002), CROSS_OVER_CHAIN(0x08, 1311015),
	MAGIC_GUARD(0x10, 2001002), BUCKSHOT(0x20, 5321054), TRIPLING_WIM(0x40, 13100022), FINAL_CUT(0x80, 4341002),
