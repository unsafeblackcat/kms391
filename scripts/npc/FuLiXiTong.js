...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var msg = "                    " + 틀 + "#l\r\n";
                msg += "#fc0xFFD5D5D5#──────────────────────────#l\r\n";
        msg += "#L3##fc0xFFFF3636#" + 每日 + "#l";   
		msg += "#L1##fc0xFFFF3636#" + 等級 + "#l";
        msg += "#L2##fc0xFFFF3636#" + 推薦 + "#l\r\n";  
        msg += "#L4##fc0xFFFF3636#" + 新建 + "#l";    
        msg += "#L5##fc0xFFFF3636#" + 補償 + "#l";     
        msg += "#L6##fc0xFFFF3636#" + 套裝 + "#l\r\n";
        cm.sendOk(msg);
        ...
        if (selection == 100) { // 사냥이벤트 아이템교환
            ...
            cm.dispose();
            cm.openNpcCustom(cm.getClient(), 3001931, "3001931");
        } else if (selection == 30) {
            cm.dispose();
            cm.openNpcCustom(cm.getClient(), 9063135, "HotTime");
        } else if (selection == 3) { // 일퀘
            cm.dispose();
            cm.openNpcCustom(cm.getClient(), 9063135, "HotTime");
        } else if (selection == 4) { // 후원룰렛
            cm.dispose();
            cm.openNpcCustom(cm.getClient(), 9063135, "FirstAccount");
        } else if (selection == 9) { //内在能力
            ...
            cm.dispose();
            cm.openNpcCustom(cm.getClient(), 9063135, "ServerBackRE");
            ...
            cm.dispose();
            cm.openNpcCustom(cm.getClient(), 9063198, "TouM");
