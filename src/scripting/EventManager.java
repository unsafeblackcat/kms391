...
public class EventManager {
	...
	public void cancel() {
		try {
			...
			System.out.println("事件名稱 : " + this.name + ", 方法名稱 : cancelSchedule:\n" + ex);
			FileoutputUtil.log("Log_Script_Except.txt",
					"事件名稱 : " + this.name + ", 方法名稱 : cancelSchedule:\n" + ex);
		}
	}
		...
		return Timer.EventTimer.getInstance().schedule(new Runnable() {
			...
			public void run() {
				try {
					...
					System.out.println(
							"事件名稱 : " + EventManager.this.name + ", 方法名稱 : " + methodName + ":\n" + ex);
					FileoutputUtil.log("Log_Script_Except.txt",
							"事件名稱 : " + EventManager.this.name + ", 方法名稱 : " + methodName + ":\n" + ex);
				}
			}
	...
	public void startInstance() {
		try {
			...
			ex.printStackTrace();
			FileoutputUtil.log("Log_Script_Except.txt", "事件名稱 : " + this.name + ", 方法名稱 : setup:\n" + ex);
		}
	}
	...
	public void startInstance(MapleCharacter character, String leader) {
		try {
			...
			System.out.println("事件名稱 : " + this.name + ", 方法名稱 : setup-Guild:\n" + ex);
			FileoutputUtil.log("Log_Script_Except.txt",
					"事件名稱 : " + this.name + ", 方法名稱 : setup-Guild:\n" + ex);
		}
	}
	...
	public void startInstance_CharID(MapleCharacter character) {
		try {
			...
			System.out.println("事件名稱 : " + this.name + ", 方法名稱 : setup-CharID:\n" + ex);
			FileoutputUtil.log("Log_Script_Except.txt",
					"事件名稱 : " + this.name + ", 方法名稱 : setup-CharID:\n" + ex);
		}
	}
	...
	public void startInstance(MapleCharacter character) {
		try {
			...
			System.out.println("事件名稱 : " + this.name + ", 方法名稱 : setup-character:\n" + ex);
			FileoutputUtil.log("Log_Script_Except.txt",
					"事件名稱 : " + this.name + ", 方法名稱 : setup-character:\n" + ex);
		}
	}
	...
	public void startInstance(MapleParty party, MapleMap map, int maxLevel) {
		try {
			...
			EventInstanceManager eim = (EventInstanceManager) this.iv.invokeFunction("setup",
					Math.min(maxLevel, averageLevel /= size), party.getId());
			eim.registerParty(party, map);
		} catch (ScriptException ex) {
			System.out.println("事件名稱 : " + this.name + ", 方法名稱 : setup-partyid:\n" + ex);
			FileoutputUtil.log("Log_Script_Except.txt",
					"事件名稱 : " + this.name + ", 方法名稱 : setup-partyid:\n" + ex);
		} catch (Exception ex) {
	...
	public void startInstance_NoID(MapleParty party, MapleMap map, Exception old) {
		try {
			...
			System.out.println("事件名稱 : " + this.name + ", 方法名稱 : setup-party:\n" + ex);
			FileoutputUtil.log("Log_Script_Except.txt", "事件名稱 : " + this.name + ", 方法名稱 : setup-party:\n"
	...
	public void startInstance(EventInstanceManager eim, String leader) {
		try {
			...
			System.out.println("事件名稱 : " + this.name + ", 方法名稱 : setup-leader:\n" + ex);
			FileoutputUtil.log("Log_Script_Except.txt",
					"事件名稱 : " + this.name + ", 方法名稱 : setup-leader:\n" + ex);
		}
	}
