...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        //choose += "#fs15##L0##fc0xFF000000#" + 강화 + " [프레이] 제네시스 무기제작#l\r\n\r\n";
        //choose += "#fs15##L2##fc0xFF000000#" + 강화 + " [프레이] 안드로이드승급#l\r\n\r\n";	
        //choose += "#fs15##L1##fc0xFF000000#" + 강화 + " [프레이] 에테르넬 승급#l\r\n\r\n";
        //choose += "#fs15##L3##fc0xFF000000#" + 강화 + " [프레이] 에테르넬 승급#l\r\n\r\n";	
        //choose += "#fs15##L4##fc0xFF000000#" + 강화 + " [프레이] 칠흑 아이템 승급#l\r\n\r\n";		
        //choose += "#fs15##L5##fc0xFF000000#" + 강화 + " 기타 악세 아이템 제작#l\r\n\r\n";		
 //       choose += "#fs15##L1##fc0xFF000000#" + 강화 + " [프레이] 후원 커스텀 제작#l\r\n\r\n";
        choose += "#fs15##L2##fc0xFF000000#" + 강화 + " [프레이] 후원 커스텀 제작 2기#l\r\n\r\n";
		choose += "#fs15##L3##fc0xFF000000#" + 강화 + " [프레이] 후원 커스텀 제작 3기#l\r\n\r\n";		
        choose += "#fs15##L5##fc0xFF000000#" + 강화 + " [프레이] 후원 커스텀 제작 4기#l\r\n\r\n";
      //  choose += "#fs15##L8##fc0xFF000000#" + 강화 + " [프레이] 후원 커스텀 제작 5기#l\r\n\r\n";
     //   choose += "#fs15##L9##fc0xFF000000#" + 강화 + " [프레이] 후원 커스텀 제작 6기#l\r\n\r\n";
