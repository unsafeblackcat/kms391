...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        qm.sendYesNo("검은 마법사의 잔상을 격파하고 #i4036462# #b#z4036462# 1개#k를 구해다 주십시오. 그리고 군단장 #r하드 데미안#k의 잔상을 격파하는 겁니다. 가능하시겠습니까?");
    } else if (status == 1) {
        var chat ="어둠의 흔적은 특수한 조건 하에서만 깃든다는 점을 이미 알고 계실 겁니다. 아래의 조건을 만족하여 #r하드 데미안#k을 격파하고 돌아와 주십시오.\r\n\r\n"
...
function startQuest() {
    MapleQuest.getInstance(35662).forceStart(qm.getPlayer(), 0, null);
    qm.forceStartQuest();
    qm.dispose();
}
