...
function action(mode, type, selection)
{
	...
	if (status == 0) {
		...
		selStr += "#fs11##fc0xFF000000#[#e#rEASY#k#l]#k";
                        selStr += "\r\n#L1##fc0xFF6799FF#Lv.200#d | "+starForceImg+" 50  | 자쿰#l\r\n";
		...
		selStr += "#fs11##fc0xFF000000#[#e#rHARD#k#l]#k\r\n";
						selStr += "#L17##fc0xFF6799FF#Lv.200#d | "+starForceImg+" 100  | 우르스#l\r\n";
		...
		selStr += "#fs11##fc0xFF000000#[#e#rHIDDEN#k#l]#k\r\n";				
						selStr += "#L27##fc0xFF6799FF#Lv.250#d | "+starImg+" 100  | 가엔슬#l\r\n";
                        selStr += "#L22##fc0xFF6799FF#Lv.265#d | "+starImg+" 200  | 세렌#l\r\n";
						selStr += "#L23##fc0xFF6799FF#Lv.300#d | "+starImg+" 330  | 칼로스#l\r\n";
						selStr += "#L28##fc0xFF6799FF#Lv.300#d | "+starImg+" 330  | 카링#l\r\n\r\n\r\n";
		//selStr += "#fs11##fc0xFF000000#[#e#rOVERSEAS#k#l]#k";				
						//selStr += "\r\n#L24##fc0xFF6799FF#Lv.300#d | "+starImg+" 330  | [해외] 텐구#l\r\n";
						//selStr += "#L25##fc0xFF6799FF#Lv.300#d | "+starImg+" 330  | [해외] 진격의거인#l\r\n";
						//selStr += "#L26##fc0xFF6799FF#Lv.300#d | "+starImg+" 330  | [해외] 아케치 미츠히데#l\r\n";
