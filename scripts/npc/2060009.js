...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var msg = "#fs11#\r\n";
        var chat = enter
        var msg = "#fs11##r어서오세요 #h0#님! 무엇을 제작하시겠어요?\r\n";
        //msg += "#L1000##b[프레이] 메인아이템 승급\r\n\r\n#l"
        msg += "#L2001##b[프레이] 커스텀 제작\r\n\r\n#l"
        msg += "#L1004#[프레이] 후원 커스텀 제작\r\n\r\n#l"
       // msg += "#L1001#칠요의 몬스터파커 훈장 제작\r\n#l"
        //msg += "#L1002#[프레이] 칭호를 승급하고 싶어요.\r\n#l"
      //  msg += "#L2000#[프레이] 자동 티어사냥터 훈장 승급\r\n\r\n"
        //msg += "#L1003#칠요의 뱃지 제작\r\n\r\n#l"
    //    msg += "#L1005#[프레이] 커플링/우정링제작\r\n#l"
        ...
        if (selection == 0) {
            ...
            cm.dispose();
            cm.openNpc(9062330); //잡화
        } else if (selection == 1005) {
            cm.dispose();
            cm.openNpc(1540859); //환불 교환	
            ...
            cm.dispose();
            cm.openNpc(9062050); //장비승급
        } else if (selection == 2001) {
            cm.dispose();
            cm.openNpc(9062323); //장비승급
        }
    } else if (status == 2) {
        sell = selection;
        if (sel == 4) { // 칭호 승급
