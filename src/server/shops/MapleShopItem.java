...
public class MapleShopItem {
	...
	public MapleShopItem(int id, short buyable, int itemId, long price, int pricequantity, byte tab, int quantity,
			int period, int position, int itemRate, int buyquantity, int rechargemonth, int rechargeday, int resetday,
			int recharge, int rechargecount) {
		this.id = id;
