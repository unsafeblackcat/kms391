...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        txt = "#fs11##b각종 스탯의 티어#fc0xFF000000#를 올릴 수 있는 시스템이라네 원하는 항목을 골라보게나#n#k\r\n\r\n#b"
        txt += "#L0# 데미지 티어\r\n"
        txt += "#L1# 경험치 티어\r\n"
        txt += "#L3# 크리 데미지 티어\r\n"
        txt += "#L4# 보스 공격력 티어\r\n"
        ...
        if (sel == 0) {
            ...
            txt = "#fs11##b현재 나의 크리데미지 티어#k #e[" + mytear + "티어]#n\r\n"
            ...
            txt = "#fs11##b현재 나의 보스 공격력 티어#k #e[" + mytear + "티어]#n\r\n"
            txt += "#b다음 승급 티어 #k#e[" + uptear + "티어]#n\r\n"
            txt += "#b승급 가능한 최대 티어는#k #e[8티어]#n\r\n"
            txt += "승급한 티어의 효과와\r\n승급에 필요한 #r아이템#k은 다음과 같습니다\r\n\r\n";
            txt += "#r#e승급 시 10% ~ 80% 랜덤으로 스텟이 올라갑니다.#k\r\n\r\n"
