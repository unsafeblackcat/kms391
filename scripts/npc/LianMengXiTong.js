...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		msg += "#L1##fc0xFFFF3636#" + 聯盟商店 + "#l";
        msg += "#L3##fc0xFFFF3636#" + 奬勵 + "#l";
        msg += "#L4##fc0xFFFF3636#" + 成就 + "#l\r\n";
        msg += "#L5##fc0xFFFF3636#" + 成就1 + "#l";
        cm.sendOkS(msg,0x86);
        ...
        if (selection == 100) { // 사냥이벤트 아이템교환
            ...
            cm.dispose();
            cm.openNpcCustom(cm.getClient(), 9010106, "9010106");
		...
		cm.dispose();
         ...
         cm.openNpcCustom(cm.getClient(), 9010106, "UnionRE");
            ...
            cm.dispose();
            cm.openNpcCustom(cm.getClient(), 9010106, "UnionRE2");
