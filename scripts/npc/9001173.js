...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        if (cm.getPlayer().getKeyValue(210223, "pia_tuto") > 0) {
            var talk = "내가 준비한 미니게임에서 이벤트 참여해서 아이템을 얻어봐~\r\n"
        ...
        if (cm.getPlayer().getKeyValue(210223, "pia_tuto") > 0) {
            switch (sel) {
                ...
                case 5://레인보우 러쉬 참여하기
                    ...
                    break;
                case 6://레인보우 러쉬 설명듣기
                    cm.sendNextS("\r\n#b#e레인보우 러쉬#n#k는 이쁜 바닷길을 달리는 게임이야~", 0x04);
                    break;
                case 100:
                    cm.dispose();
                    break;
            ...
            switch (sel) {
                ...
                case 5://레인보우 러쉬 입장하기
                    if (cm.getPlayer().getParty() != null) {
						...
						cm.getPlayer().runRainBowRush();
						cm.dispose();
                    }
                    break;
                case 6://레인보우 러쉬 설명듣기
                    cm.sendNextPrevS("\r\n신비한 #b#e초고속 보트#n#k을 타고 무지갯빛 길을 마음껏 달려봐~", 0x04);
                    break;
            }
        } else {
        ...
        if (cm.getPlayer().getKeyValue(210223, "pia_tuto") > 0) {
            switch (sel) {
                ...
                case 4://높이높이 네오캐슬 설명듣기
                    ...
                    break;
                case 6://레인보우 러쉬 설명듣기
                    cm.sendNextPrevS("\r\n점점 더 빨라지는 초고속 보트를 타고 #e#b좌우 방향키#k#n를 이용해 장애물을 피해야 해~\r\n\r\n#b#e순발력#n#k이 필요하겠지~?", 0x04);
                    break;
            }
        } else {
