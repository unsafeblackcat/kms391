...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		msg += "#L8# #b인내의 숲으로 이동합니다.#n #k\r\n";
		msg += "#L98# #b[PRAY]유저 개인맵으로 이동합니다.#n #k\r\n";
		...
		switch (ans_01) {
			...
			case 3:
				...
				selStr += "#L3# #e#d후원 사냥터 [브론즈] #n #k이동\r\n";
				selStr += "#L4# #e#d후원 사냥터 [실버]#n #k이용\r\n";
				selStr += "#L8# #e#d후원 사냥터 [골드]#n #k이용\r\n";
			...
			case 4:
			    ...
			    selStr += "사냥에 도움이 되는 많은곳들이 있답니다.\r\n어디로 이동하시겠어요?\r\n";
				selStr += "#L1##fs11# #e#d[티어] 브론즈 사냥터#n #k이동\r\n";
				//selStr += "#L2# #e#d[티어] 노예 사냥터#n #k이동\r\n";
				selStr += "#L3# #e#d[티어] 실버 사냥터#n #k이동\r\n";
				//selStr += "#L4# #e#d[티어] 실버 사냥터#n #k이동\r\n";
				selStr += "#L5# #e#d[티어] 골드 사냥터#n #k이동\r\n";
				//selStr += "#L6# #e#d[티어] 남작 사냥터#n #k이동\r\n";
				selStr += "#L7# #e#d[티어] 플레티넘 사냥터#n #k이동\r\n";
				//selStr += "#L8# #e#d[티어] 백작 사냥터#n #k이동\r\n";
				//selStr += "#L9# #e#d[티어] 공작 사냥터#n #k이동\r\n";
				selStr += "#L10# #e#d[티어] 다이아 사냥터#n #k이동\r\n";                
				break;
			case 5:
				cm.dispose();
				cm.openNpc(9001153);
