...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var msg = "#fs13#這裏記錄該服務器所有GM運營地圖 包括歷史升級版本\r\n";
        msg += "#fs15#\r\n        #fc0xFF191919#───────────歷史記錄───────────#k\r\n";
        msg +=  "　　        　#L1##fc0xFFF29661#" + 템버리기 +  "管理員地圖[PRAY服]#l\r\n\r\n";
        msg += "#L2##fc0xFFDF4D4D#" + 템버리기+ "管理員地圖[Fancy服]#l"; msg +=  "#L3##fc0xFFDF4D4D#" + 템버리기 +  "管理員地圖[Meng服]#l\r\n\r\n";
        msg += "\r\n        #fc0xFF191919#───────────歷史記錄───────────#k\r\n";
        msg += "　　　　　 #L6##fc0xFFDF4D4D#" + 템버리기+ "組隊任務地點#l\r\n\r\n";       
        msg += "　　#L8##fc0xFF6B66FF#" + 템버리기+ "活動跳跳地圖#n #k";        msg += "　#L10##fc0xFF6B66FF#" + 템버리기+ "賭場遊樂場#l\r\n\r\n";
        ...
        switch (ans_01) {
            ...
            case 6:
                selStr += "\r\n";
                selStr += "#L1##fs15# #e#d루디브리엄 파티퀘스트#n #k이동\r\n";
            ...
            case 7:
                selStr += "\r\n";
                selStr += "#L1##fs15# #e#d14주년 행성 비타#n #k이동\r\n";
            ...
            case 4:
                ...
                selStr += "#L1##fs15# #e#d[티어] 노예 사냥터#n #k이동\r\n";
        ...
        if (ans_01 == 3) {
            ...
            switch (ans_02) {
                case 1:
                    selStr += "#fs15#\r\n사냥터에 등장하는 #fc0xFF1DDB16##e몬스터의 평균 레벨#n#k을 확인하고 이동하세요.#fs15#\r\n";
