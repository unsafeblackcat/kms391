...
public class DunkelEliteBoss {
	...
	public DunkelEliteBoss(short bosscode, short v1, int unk1, int unk2, int unk3, int unk4, int unk5, int unk6,
			int unk7, short v2, short Arrowvelocity, short v3, byte b1, byte b2, Point p1, Point p2, Point p3, short v4,
			short v5) {
