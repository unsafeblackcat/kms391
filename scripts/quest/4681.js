...
function start(mode, type, selection) {
	...
	if (status == 40) {
	    qm.sendOk("I understand that you feel trepidations about helping out a strange town like Zipangu. I am the one that is unaffected by #bThe Spell of Acacia#k, which means I will have to risk my Luna to save this town from total destruction.");
	    qm.dispose();
	    return;
	}
	status--;
	...
	case 21:
	    ...
	    break;
	case 22:
	    qm.sendNextPrev("I don't know about you, but I was furious. Furious at the thought of my Luna being pre-determined by this miniscule copy of a book...");
	    break;
	case 23:
	...
	case 48:
	    ...
	    break;
	case 49:
	    qm.sendNextPrev("For the next 10 years, the lord of the castle that was controlled by the goblin made Luna here miserable, but one day, a brave Samurai appeared in Zipangu and proceeded to defeat the goblin, bringing peace back to this place.");
	    break;
	case 50:
