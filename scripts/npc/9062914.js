...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        ...
        if (cm.getPlayer().getPPoint("A") < 0) {
            cm.getPlayer().setPPoint("A", 0);
        }
        var msg = "#fs11# 안녕하세요. #ePRAY#n 홍보포인트 지급 도우미 입니다.\r\n " + enter;
        msg += "현재 #b#h ##k님의 홍보 포인트 : #b" + cm.getPlayer().getPPoint("A") + "P#k" + enter;
        ...
        switch (seld) {
            ...
            case 4:
                ...
                break;
            case 5:
                if (cm.getPlayer().getPPoint("A") < itx['price']) {
                ...
                cm.getPlayer().gainPPoint("A", -itx['price']);
                ...
                msg += "현재 #h 0#님의 남은 홍보포인트 : #e#b" + cm.getPlayer().getPPoint("A") + "P#k#n";
                cm.sendOk(msg);
                cm.dispose();
                break;
            case 6:
        ...
        switch (seld) {
            case 1:
                ...
                */
                ...
                cm.getPlayer().gainPPoint("A", reward);
