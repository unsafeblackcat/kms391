...
public class MapleStorage implements Serializable {
	...
	public void saveToDB(Connection con) {
		...
		try {
			...
			MapleInventoryType[] types = { MapleInventoryType.EQUIP, MapleInventoryType.USE, MapleInventoryType.SETUP,
					MapleInventoryType.ETC, MapleInventoryType.CASH, MapleInventoryType.CODY };
	...
	public void arrange() {
		Collections.sort(this.items,
				(o1, o2) -> (o1.getItemId() < o2.getItemId()) ? -1 : ((o1.getItemId() == o2.getItemId()) ? 0 : 1));
		for (MapleInventoryType type : MapleInventoryType.values()) {
	...
	public void sendStorage(MapleClient c, int npcId) {
		this.lastNPC = npcId;
		Collections.sort(this.items,
				(o1, o2) -> (GameConstants.getInventoryType(o1.getItemId()).getType() < GameConstants
						.getInventoryType(o2.getItemId()).getType()) ? -1
								: ((GameConstants.getInventoryType(o1.getItemId()) == GameConstants
										.getInventoryType(o2.getItemId())) ? 0 : 1));
		for (MapleInventoryType type : MapleInventoryType.values()) {
			this.typeItems.put(type, this.items);
		}
