...
function action(mode, type, selection) {
	...
	if (status == 0) {
	var chat= "#fs15#마음에 드시는 친구가 생기셨나요? 함께 특별한 반지로 우정을 나누어보세요!";
	chat += "\r\n";
	chat += "\r\n#k#fs15#----------------------커플링 목록----------------------#fs15#\r\n";
	...
	sel = selection;
		...
		msg += "#L100##fs15# 후원 포인트 (올스텟 300/ 공마 300, "+price1+"포인트 지불)\r\n";
		msg += "#L101##fs15# 홍보 포인트 (올스텟 300/ 공마 300, "+price2+"포인트 지불)\r\n";
