...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendGetNumber(9000030, "인벤토리에 #i4310229# #b#z4310229# (교환불가)#k 아이템이 #b" + leaf + "개#k 있습니다. #b#e한 번에 몇 개#k#n를 사용하시겠습니까?", leaf, 1, leaf);
    } else if (status == 1) {
        if (leaf < selection) {
        ...
        count = selection;
        cm.sendYesNoS("#i4310229# #b#z4310229# (교환불가)#k 아이템을 #b" + selection + "개#k 사용하여 #b#z4310229# " + selection + "개#k를 획득하시겠습니까?", 4, 9000030);
    } else if (status == 2) {
