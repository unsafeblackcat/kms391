...
public class AvatarLook {
	...
	private int gender, skin, face, hair, job, mega, weaponStickerID, weaponID, subWeaponID, drawElfEar,
			pinkbeanChangeColor, demonSlayerDefFaceAcc, xenonDefFaceAcc, arkDefFaceAcc, hoyeongDefFaceAcc,
			isZeroBetaLook, addColor, baseProb, hoyeongAvater;
	...
	public static AvatarLook makeRandomAvatar() {
		...
		int[][] items = { { 1002186, 1003250, 1000599 }, { 1012104, 1012379 }, { 1022079, 1022285 }, { 1032024 },
				{ 1052975, 1053257, 1053351 }, { 1062183 }, { 1072153 }, { 1082102 }, { 1103068 } };
	...
	public boolean compare(AvatarLook a) {
		if (a.gender != this.gender || a.skin != this.skin || a.face != this.face || a.hair != this.hair
				|| a.subWeaponID != this.subWeaponID || a.weaponStickerID != this.weaponStickerID) {
			return false;
		}
		for (int i = 1; i <= 9; i++) {
	...
	public static void decodeUnpackAvatarLook(AvatarLook a, LittleEndianAccessor slea) throws IOException {
		...
		if (equip5_1 != 1023) {
			a.items.put(Byte.valueOf((byte) 5),
					Integer.valueOf(equip5_1 + 1000 * (equip5_2 + 10 * (equip5_check ? 105 : 104))));
		}
	...
	public void encodeUnpackAvatarLook(MaplePacketLittleEndianWriter mplew) {
		...
		Integer[] wt = { Integer.valueOf(30), Integer.valueOf(31), Integer.valueOf(32), Integer.valueOf(33),
				Integer.valueOf(37), Integer.valueOf(38), Integer.valueOf(40), Integer.valueOf(41), Integer.valueOf(42),
				Integer.valueOf(43), Integer.valueOf(44), Integer.valueOf(45), Integer.valueOf(46), Integer.valueOf(47),
				Integer.valueOf(48), Integer.valueOf(49), Integer.valueOf(39), Integer.valueOf(34), Integer.valueOf(52),
				Integer.valueOf(53), Integer.valueOf(35), Integer.valueOf(36), Integer.valueOf(21), Integer.valueOf(22),
				Integer.valueOf(23), Integer.valueOf(24), Integer.valueOf(56), Integer.valueOf(57), Integer.valueOf(26),
				Integer.valueOf(58), Integer.valueOf(27), Integer.valueOf(28), Integer.valueOf(59), Integer.valueOf(29),
				Integer.valueOf(213), Integer.valueOf(214), Integer.valueOf(0) };
	...
	public static final void encodeAvatarLook(final MaplePacketLittleEndianWriter mplew, final MapleCharacter chr,
			final boolean mega, boolean second, boolean update) {
		// -> 1.2.390 Changed.
		...
		for (final Map.Entry<Short, Integer> item : equip.entrySet()) {
			...
			if (GameConstants.isAngelicBuster(chr.getJob()) && second) {
			...
			} else if (isAlpha || (GameConstants.isAngelicBuster(chr.getJob()) && !second)
					|| (!GameConstants.isZero(chr.getJob()) && !GameConstants.isAngelicBuster(chr.getJob()))) {
				...
				if ((pos < 100) && (myEquip.get((byte) pos) == null)) {
					...
					/*
					 * pos = (byte) (pos - 100); if (myEquip.get(pos) != null) {
					 * maskedEquip.put((byte) pos, myEquip.get(pos)); } myEquip.put((byte) pos,
					 * item.getValue());
					 */
		...
		if (GameConstants.isKhali(chr.getJob()) || GameConstants.isAdel(chr.getJob())
				|| GameConstants.isArk(chr.getJob()) || GameConstants.isIllium(chr.getJob())
