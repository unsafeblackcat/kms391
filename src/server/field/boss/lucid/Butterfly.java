...
public class Butterfly {
	...
	public static void load() {
		...
		try {
			MapleData butterflyData = MapleDataProviderFactory
					.getDataProvider(new File(System.getProperty("wz") + "/Etc.wz")).getData("BossLucid.img")
					.getChildByPath("Butterfly");
			...
			System.err.println(
					"[Butterfly] " + System.getProperty("wz") + "/Etc.wz/BossLucid.img/Butterfly is not found.");
		}
	}
