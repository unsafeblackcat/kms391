...
function action(mode, type, selection, selection2) {
    ...
    if (status == 0) {
        ...
        타입 = "";
        if (st == 0) {
            말 += "" + 파랑 + "#e#fs15##fc0xFF6B66FF##e選擇想要的清單#n#k#fs15#中的髮型!\r\n\r\n"
            if (st2 == 0) {
                ...
                if (cm.getPlayer().getGender() == 0) {
                    말 += "#r(Alpha Hair共有 " + mhair.length + "頁.)#k#n\r\n\r\n"
                    for (i = 0; i < mhair.length; i++) {
                        if (i == 0) {
                            타입 = "" + 보라 + " #fc0xFF5C1DB5#A"
                        } else if (i == 1) {
                    ...
                    말 += "#r(Beta Hair共有 " + fhair.length + "頁.)#k#n\r\n\r\n"
                    for (i = 0; i < fhair.length; i++) {
                        if (i == 0) {
                            타입 = "" + 보라 + " #fc0xFF5C1DB5#A"
                        } else if (i == 1) {
            ...
            말 += "#fs15#勇士喜歡什麼樣的臉?\r\n";
            if (st2 == 0) {
                말 += "#r(Alpha Face共有 " + mface.length + "頁.)#k#n\r\n\r\n"
                for (i = 0; i < mface.length; i++) {
                    말 += "#L" + i + "# " + (parseInt(i) + 1) + "選擇頁面整形樣式.#l\r\n";
                }
            } else if (st2 == 1) {
                말 += "#r(Beta Face 共有" + fface.length + "頁.)#k#n\r\n\r\n"
                for (i = 0; i < fface.length; i++) {
                    말 += "#L" + i + "# " + (parseInt(i) + 1) + "選擇頁面整形樣式.#l\r\n";
                }
            } else {
                if (cm.getPlayer().getGender() == 0) {
                    말 += "#r(Alpha整形共分為 " + mface.length + "頁.)#k#n\r\n\r\n"
                    for (i = 0; i < mface.length; i++) {
                        말 += "#L" + i + "# " + (parseInt(i) + 1) + "選擇頁面整形樣式.#l\r\n";
                    }
                } else {
                    말 += "#r(Beta整形共分為 " + fface.length + "頁.)#k#n\r\n\r\n"
                    for (i = 0; i < fface.length; i++) {
                        말 += "#L" + i + "# " + (parseInt(i) + 1) + "選擇頁面整形樣式.#l\r\n";
                    }
