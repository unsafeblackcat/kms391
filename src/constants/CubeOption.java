...
public class CubeOption {
	...
	/*
	 * Opcode count of 19376 triggered aggressive code reduction. Override with
	...
	public static int getRedCubePotentialId(int itemid, int grade, int num, int... args) {
		...
		block154: {
			...
			type = GameConstants.isWeapon(itemid) || GameConstants.isSecondaryWeapon(itemid) ? 1302
					: (GameConstants.isCap(itemid) ? 1004
							: (GameConstants.isCape(itemid) ? 1102
									: (type == 1132 || type == 1152 ? 1132
											: (GameConstants.isLongcoat(itemid) || type >= 1040 && type <= 1042 ? 1042
													: (type >= 1070 && type <= 1073 ? 1073
															: (type >= 1080 && type <= 1082 ? 1082
																	: (type >= 1061 && type <= 1063 ? 1062
																			: (type == 1672 ? 1672
																					: (type == 1190 || type == 1191
																							? 1190
																							: 1122)))))))));
	...
	public static int getPlatinumUnlimitiedCubePotentialId(int itemid, int grade, int num, int... args) {// num == 옵션 붙는
																											// 줄
		LinkedHashMap<Integer, Integer> list = new LinkedHashMap<Integer, Integer>();
		int potentialid = 0;
		int type = itemid / 1000;
		type = GameConstants.isWeapon(itemid)
				|| GameConstants.isSecondaryWeapon(itemid)
						? 1302
						: (GameConstants.isCap(itemid) ? 1004
								: (GameConstants.isCape(itemid) ? 1102
										: (type == 1132 || type == 1152 ? 1132
												: (GameConstants.isLongcoat(itemid) || type >= 1040 && type <= 1042
														? 1042
														: (type >= 1070 && type <= 1073 ? 1073
																: (type >= 1080 && type <= 1082 ? 1082
																		: (type >= 1061 && type <= 1063 ? 1062
