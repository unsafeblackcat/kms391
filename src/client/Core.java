...
public class Core implements Comparable<Core> {
	...
	public Core(long crcid, int coreid, int charid, int level, int exp, int state, int maxlevel, int skill1, int skill2,
			int skill3, int position, SpecialCoreOption spCoreOption) {
		setCrcId(crcid);
		setCoreId(coreid);
		setCharId(charid);
		setLevel(level);
