...
public class ForceAtom {
	...
	public ForceAtom(int nInc, int nFirstImpact, int nSecondImpact, int nAngle, int nStartDelay, int nStartX,
			int nStartY, long dwCreateTime, int nMaxHitCount, int nEffectIdx) {
		this.nAttackCount = 1;
		this.nInc = nInc;
		this.nFirstImpact = nFirstImpact;
		this.nSecondImpact = nSecondImpact;
