...
public class SecondAtom2 {
	...
	public SecondAtom2(int dataIndex, int target, int createDelay, int enableDelay, int expire, int enableCustom,
			int attackableCount, Point pos, int rotate, List<Point> extraPos, List<Integer> custom, int localOnly,
			int sourceId) {
