...
function action(mode, type, sel) {
   ...
   if (status == 0) {
      var msg = "#fs15#제작하실 아이템을 선택해주세요."+enter;
      msg += "#fs15#레시피와 아이템의 정보는 선택하면 나옵니다.#fs15##b"+enter;
      for (i = 0; i < items.length; i++)
         msg += "#fs15##L"+i+"##i"+items[i]['itemid']+"##z"+items[i]['itemid']+"# 제작"+enter;
      ...
      var msg = "#fs15#선택하신 아이템은 다음과 같습니다.#fs15##b"+enter;
      ...
      msg += enter;
      msg += "#fs15##k선택하신 아이템을 제작하기 위한 레시피입니다.#fs15##d"+enter;
      msg += "#fs15##r해당 아이템은 이노센트 류 주문서를 바르면 안됩니다.#k"+enter+enter;
      ...
      if (Packages.server.Randomizer.rand(1, 100) <= item['chance']) {
         gainItem(item);
         cm.sendOk("#fs15#축하드립니다. 제작에 성공하였습니다");
