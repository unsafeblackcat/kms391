...
function action(mode, type, selection) {
	...
	if (status == 0) {
		var msg = "#fs15#只有擊敗强大BOSS的人才能獲得 #r#e#i4310308:# #t4310308##n#k."+enter;
		msg += "#L0# #r#e<Neo覈心商店>#n立即使用.#k#l"+enter;
		msg += "#L1# #b#e<Neo覈心>#n立即領取.#k#l"+enter;
		// 現時不使用每週處理，請移除確認
		msg += "#L2# #b#e<Neo之力>#n를 받고 싶습니다.#k#l"+enter;
		msg += "#L3# #e<Neo覈心>#n系統說明.#k#l"+enter;
		msg += "#L4# #e<Neo之力>#n系統說明.#k#l";
		cm.sendNext(msg);
	} else if (status == 1) {
		if (sel == -1)
		sel = selection;
