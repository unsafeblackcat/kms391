			...
			for (final MapleData dat : nameData) {
				...
				case "BoardInfo": {
					for (final MapleData d : dat) {
						...
						UnionHandler.boardPos.add(new Point(MapleDataTool.getInt(d.getChildByPath("xPos")),
								MapleDataTool.getInt(d.getChildByPath("yPos"))));
				...
				case "Card": {
					for (final MapleData d : dat) {
						UnionHandler.cardSkills.put(Integer.parseInt(d.getName()),
								MapleDataTool.getInt(d.getChildByPath("skillID")));
					}
					continue;
				}
				case "CharacterSize": {
