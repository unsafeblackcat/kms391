...
public class MapleTrait {
	...
	public enum MapleTraitType {
		charisma(500, MapleStat.CHARISMA), insight(500, MapleStat.INSIGHT), will(500, MapleStat.WILL),
		craft(500, MapleStat.CRAFT), sense(500, MapleStat.SENSE), charm(5000, MapleStat.CHARM);
