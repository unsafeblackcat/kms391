...
public class ItemMakerFactory {
	...
	protected ItemMakerFactory() {
		MapleData info = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("wz") + "/Etc.wz"))
		...
		for (MapleData dataType : info.getChildren()) {
			...
			case 16:
				for (MapleData itemFolder : dataType.getChildren()) {
					...
					ItemMakerCreateEntry imt = new ItemMakerCreateEntry(cost, reqLevel, reqMakerLevel, quantity,
