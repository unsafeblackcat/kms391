...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        msg += "#L3##fc0xFFFF3636#" + 每日任務 + "#l";
        msg += "#L2##fc0xFFFF3636#" + 賽季通行證 + "#l\r\n";
        msg += "#L30##fc0xFFFF3636#" + 陞級 + "#l";
        msg += "#L5##fc0xFFFF3636#" + 排名 + "#l";
        msg += "#L6##fc0xFFFF3636#" + 轉世 + "#l\r\n";
        cm.sendOk(msg);
        ...
        cm.sendOk("#fs15#이미 지급받은 보상으로 지급이 불가능합니다.");
        cm.dispose();
        ...
        cm.sendOk("#fs15#유니온 #r6000레벨#k 달성을 축하드립니다!\r\n\r\n#b#i4319999# 1000개와 10억 메소를 지급 해드렸어요.");
