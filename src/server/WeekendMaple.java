...
public enum WeekendMaple {
	STARFORCE_DISCOUNT(0, 0, "주문의 흔적 상시 버닝!"), AMAZINGSCROLL_ADD(0, 1, "소울 조각 사용 시 위대한 소울 획득 확률 5배!"),
	STARFORCE_ADDPROB(1, 0, "주문의 흔적 상시 버닝!"), SOUL_ADDPROB(1, 1, "소울 조각 사용 시 위대한 소울 획득 확률 5배!");
