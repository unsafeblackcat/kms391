...
public class SkillPacket {
	...
	public static byte[] createSecondAtom(final List<MapleSecondAtom> msa) {
		...
		for (final MapleSecondAtom atom : msa) {
			...
			mplew.writeInt(atom.getSecondAtoms().getSourceId() == 2121052 ? 2
					: atom.getSecondAtoms().getSourceId() == 63101104 ? 1 : 0);
			mplew.writeInt(atom.getSecondAtoms().getDataIndex());
			mplew.writeInt(atom.isNumuse() ? atom.getNum() : i++);
			mplew.writeInt((atom.getSecondAtoms().getLocalOnly() == 1) ? atom.getSecondAtoms().getTarget()
					: atom.getChr().getId());
			...
			mplew.writeInt(atom.getChr().isFacingLeft() ? (-atom.getSecondAtoms().getRotate())
					: atom.getSecondAtoms().getRotate());
			mplew.writeInt(atom.getSecondAtoms().getSourceId());
			mplew.writeInt(0);
			mplew.writeInt(atom.getSecondAtoms().getSourceId() == 2121052 ? 1 : 0);
			mplew.writeInt((atom.getSecondAtoms().getSourceId() == 400031066)
					? (atom.getSecondAtoms().getExpire() + atom.getChr().getSkillCustomValue0(400031066) * 1000L)
					: ((long) atom.getSecondAtoms().getExpire()));
			mplew.writeInt(atom.getChr().isFacingLeft() ? (-atom.getSecondAtoms().getRotate())
					: atom.getSecondAtoms().getRotate());
			mplew.writeInt(atom.getSecondAtoms().getAttackableCount());
			mplew.writeInt(atom.getSecondAtoms().getLocalOnly());
			mplew.writeInt(0);
			mplew.writeInt(atom.getPos().x + (atom.getChr().isFacingLeft() ? (-atom.getSecondAtoms().getPos().x)
					: atom.getSecondAtoms().getPos().x));
	...
	public static byte[] CreateSubObtacle(final MapleCharacter chr, final MapleSummon summon,
			final List<Triple<Integer, Integer, Integer>> list, final int type) {
		final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
		mplew.writeShort(SendPacketOpcode.SPAWN_SECOND_ATOMS.getValue());
	...
	public static byte[] CreateSubObtacle(final MapleCharacter chr, final int skillid) {
		...
		for (int i = 1; i <= 5; ++i) {
			...
			mplew.writeInt(0);
			mplew.writeInt(0);
			mplew.writeInt((i == 1) ? chr.getPosition().x
					: ((i == 2) ? (chr.getPosition().x + 40)
							: ((i == 3) ? (chr.getPosition().x - 40)
									: ((i == 4) ? (chr.getPosition().x + 80)
											: ((i == 5) ? (chr.getPosition().x - 80) : 0)))));
			mplew.writeInt((i == 1) ? (chr.getPosition().y - 110)
					: ((i == 2 || i == 3) ? (chr.getPosition().y - 100)
							: ((i == 4 || i == 5) ? (chr.getPosition().y - 90) : 0)));
			mplew.write(0);
			mplew.write(0);
			mplew.write(0);
			mplew.writeInt(0);
	...
	public static byte[] CreateSworldObtacle(final MapleMagicSword ms) {
		...
		if (ms.core()) {
			...
			mplew.writeInt(0);
			mplew.writeInt(ms.getDuration());
			mplew.writeInt(ms.getChr().getPosition().x + ((ms.getSwordCount() == 0 || ms.getSwordCount() == 2
					|| ms.getSwordCount() == 4 || ms.getSwordCount() == 6 || ms.getSwordCount() == 8) ? 30 : -30));
	...
	public static byte[] 권술호접지몽(final MapleCharacter chr) {
		...
		if (Randomizer.isSuccess(35)) {
			mplew.write(HexTool.getByteArrayFromHexString(
					"01 D2 00 00 00 01 00 00 00 2C 00 00 00 03 00 00 00 F5 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 A3 60 31 15 00 00 00 00 00 00 00 00 00 00 00 00 01 D3 00 00 00 02 00 00 00 2A 00 00 00 04 00 00 00 7A 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 A3 60 31 15 00 00 00 00 00 00 00 00 00 00 00 00 01 D4 00 00 00 03 00 00 00 2A 00 00 00 04 00 00 00 7C 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 A3 60 31 15 00 00 00 00 00 00 00 00 00 00 00 00 01 D5 00 00 00 04 00 00 00 2C 00 00 00 04 00 00 00 12 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 A3 60 31 15 00 00 00 00 00 00 00 00 00 00 00 00 01 D6 00 00 00 05 00 00 00 2C 00 00 00 03 00 00 00 65 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 A3 60 31 15 00 00 00 00 00 00 00 00 00 00 00 00 00"));
		} else if (Randomizer.isSuccess(35)) {
			mplew.write(HexTool.getByteArrayFromHexString(
					"01 D7 00 00 00 01 00 00 00 2C 00 00 00 03 00 00 00 23 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 9A 64 31 15 00 00 00 00 00 00 00 00 00 00 00 00 01 D8 00 00 00 02 00 00 00 29 00 00 00 03 00 00 00 32 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 9A 64 31 15 00 00 00 00 00 00 00 00 00 00 00 00 01 D9 00 00 00 03 00 00 00 28 00 00 00 03 00 00 00 28 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 9A 64 31 15 00 00 00 00 00 00 00 00 00 00 00 00 01 DA 00 00 00 04 00 00 00 2A 00 00 00 04 00 00 00 7F 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 9A 64 31 15 00 00 00 00 00 00 00 00 00 00 00 00 01 DB 00 00 00 05 00 00 00 2C 00 00 00 03 00 00 00 3A 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 9A 64 31 15 00 00 00 00 00 00 00 00 00 00 00 00 00"));
		} else {
			mplew.write(HexTool.getByteArrayFromHexString(
					"01 DC 00 00 00 01 00 00 00 2B 00 00 00 04 00 00 00 C7 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 92 68 31 15 00 00 00 00 00 00 00 00 00 00 00 00 01 DD 00 00 00 02 00 00 00 28 00 00 00 04 00 00 00 F3 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 92 68 31 15 00 00 00 00 00 00 00 00 00 00 00 00 01 DE 00 00 00 03 00 00 00 2C 00 00 00 03 00 00 00 5E 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 92 68 31 15 00 00 00 00 00 00 00 00 00 00 00 00 01 DF 00 00 00 04 00 00 00 2B 00 00 00 04 00 00 00 C3 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 92 68 31 15 00 00 00 00 00 00 00 00 00 00 00 00 01 E0 00 00 00 05 00 00 00 28 00 00 00 03 00 00 00 5A 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 92 68 31 15 00 00 00 00 00 00 00 00 00 00 00 00 00"));
		}
		mplew.writeInt(chr.getPosition().x);
	...
	public static byte[] stackMonster(ArrayList<MapleMonster> monsters, int skillId1, int skillId2, int type,
			int duration) {
		final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
	...
	public static byte[] hexaStackAttackMonster(ArrayList<MapleMonster> monsters, int skillId, int attackSkillId,
			int delay) {
		final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
	...
	public static byte[] SpawnSpell(final int cid, final List<Integer> moblist1, final List<Integer> moblist2,
			final List<Integer> moblist3, final List<Integer> moblist4, final int count) {
		final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
