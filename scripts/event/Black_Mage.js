...
function WarptoNextStage(eim) {
    ...
    while (iter.hasNext()) {
        ...
        if (stage % 2 == 1 && stage != 8) {
            ...
            eim.getMapInstance(8).broadcastMessage(CField.enforceMSG("破壞創世之卵，結束這場漫長的戰鬥吧.", 265, 3000));
        }
    }
    if (stage == 1) {
        ...
        messagePlayer(eim, stage, "要對抗黑魔法師，必須先擊敗護衛他的創造與破壞騎士們.");
    } else if (stage == 3) {
        ...
        messagePlayer(eim, stage, "終於直接站在黑魔法師面前了。用盡全力擊敗他吧.");
    } else if (stage == 5) {
        ...
        spawnMonster(eim, stage, 8880512, 0, 85);
        spawnMonster(eim, stage, 8645064, 0, 85);
        messagePlayer(eim, stage, "那姿態彷彿獲得了神之權能。即使對手是神，為了所有人也必須在此阻止他.");
    } else if (stage == 7) {
        ...
        messagePlayer(eim, stage, "#face1# 空無一物的空間......只剩下我一個人嗎...");
    }
}
