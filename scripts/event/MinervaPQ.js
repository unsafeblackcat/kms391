...
function setup(mapid) {
    map = parseInt(mapid);
    var eim = em.newInstance("MinervaPQ");
...
function changedMap(eim, player, mapid) {
    if (mapid != 933031000 && mapid != 933032000 && mapid != 933033000 && mapid != 933034000 && mapid != 933035000 && mapid != 933036000 && mapid != 933037000) {
