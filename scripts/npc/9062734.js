...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var choose = "#fn나눔고딕#PRAY 강화 관련 NPC입니다.#fs15##k\r\n";
		choose += "#fn나눔고딕#현재 사용중인 NPC 는 강화 시스템 NPC 입니다.#fs11##k\r\n";
		choose += "\r\n\r\n"+ 연보 + "───────────────────────────#k\r\n";
                         choose += "#L19#" + 집 + " #fc0xFF0054FF#STR#l\r\n\r\n";choose += "#L20#" + 집 + " #fc0xFF0054FF#LUK#l\r\n\r\n";
                         choose += "#L21#" + 집 + " #fc0xFF0054FF#DEX#l\r\n\r\n";choose += "#L22#" + 집 + " #fc0xFF0054FF#INT#l\r\n\r\n";
                         choose += "#L23#" + 집 + " #fc0xFF0054FF#HP#l\r\n\r\n";choose += "#L24#" + 집 + " #fc0xFF0054FF#Matk#l\r\n\r\n";
                         choose += "#L25#" + 집 + " #fc0xFF0054FF#Watk#l\r\n\r\n";
      ...
      var choose = "#fs11#" + 검정 + "일일 퀘스트를 진행하시겠어요??\r\n";
		...
		if(cm.getPlayer().getAllUnion() < 8000) {
		 ...
		 cm.openNpcCustom(cm.getClient(), 1052206, "UnionRE");
           ...
           cm.dispose();
            cm.openNpc(9062734, "Reminence_ItemEnhance_STR");
        } else if (selection == 2) {
            cm.dispose();
            cm.openNpc(9001027);
        } else if (selection == 3) {
	...
	cm.openNpc(9062147);
            ...
            cm.dispose();
            cm.openNpc(9062734, "Reminence_ItemEnhance_LUK");
        } else if (selection == 21) {
            cm.dispose();
            cm.openNpc(9062734, "Reminence_ItemEnhance_DEX");
        } else if (selection == 22) {
            cm.dispose();
            cm.openNpc(9062734, "Reminence_ItemEnhance_INT");
        } else if (selection == 23) {
            cm.dispose();
            cm.openNpc(9062734, "Reminence_ItemEnhance_HP");
        } else if (selection == 24) {
            cm.dispose();
            cm.openNpc(9062734, "Reminence_ItemEnhance_Matk");
        } else if (selection == 25) {
            cm.dispose();
            cm.openNpc(9062734, "Reminence_ItemEnhance_Watk");
        }
    } else if (status == 2) {
        sell = selection;
		switch(selection) {
