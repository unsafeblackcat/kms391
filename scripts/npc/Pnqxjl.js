...
function action(mode, type, selection) {
    if (mode == -1 || mode == 0) {
        if (status == 2 && sel == 4) { //승급 거부
            cm.sendOkS("#fs15# 好吧！改變主意隨時可以回來！", 0x04, 2192030);
        }
        cm.dispose();
        return;
    }
    ...
    if (status == 0) {
        var choose = "" + 컨텐츠 + "#fn나눔고딕##fs15#\r\n";
        var chat = enter
        //choose += "" + " 　　　   　　　　    #fUI/Basic.img/theblackcoin/35#艾爾特內容系統#fUI/Basic.img/theblackcoin/35##l　\r\n";
        //choose += "" + " #dㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ  各種內容  ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ#l　\r\n";
        //choose += "#L5#" + 마라벨 + "" + 연파랑 + " 現金道具鐵砧38     #l#k";
        //choose += "#L6#" + 코인 + "" + 연파랑 + " 抽獎房　　      #l#k";
        //choose += "#L7#" + 집 + "" + 연파랑 + " 釣魚場#k\r\n\r\n";
        //choose += "#L10#" + 모루 +"" + 연파랑 + " 防具強化     #l#k";
        //choose += "#L11#" + 훈장 +"" + 연파랑 + " 飾品強化     #l#k";
        //choose += "#L12#" + 강화 +"" + 연파랑 + " 裝飾道具強化#k\r\n\r\n";
        //choose += "#L13#" + 커플 +"" + 연파랑 + " 稱號晉級所     #l#k";
        //choose += "#L9#" + 커플 + "" + 연파랑 + " 冒險鑽頭  #l#k";
        //choose += "#L14#" + 퀘스트 + "" + 연파랑 + " 自由轉職所     #l#k";
        //choose += "#L15#" + 무릉 + "" + 연파랑 + " 劍豪材料交換#l#k\r\n\r\n";
        //choose += "#L13#" + 펫 + "" + 연파랑 + " 公會系統      #l#k\r\n\r\n";
        choose += "#L16#" + 모루 + "" + 연파랑 + " 皮卡啾&雪吉拉(準備中)    #l#k\r\n\r\n";
        //choose += "#L11#" + 훈장 + "" + 연파랑 + " 聯盟裝備  #l#k\r\n\r\n";
        //choose += "#L10#" + 코인 + "" + 연파랑 + " 七曜徽章    #l#k\r\n\r\n";
        //choose += "" + " #dㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ  抽獎系統  ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ#l　\r\n";
        //choose += "#L0#" + 뎀스 + "" + 블루 + " 希德戒指抽獎     #l#k";
        //choose += "#L2#" + 의자 + "" + 블루 + " 椅子抽獎#k\r\n\r\n";
        //choose += "#L1#" + 뎀스 + "" + 블루 + " 騎寵抽獎     #l#k";
        //choose += "#L3#" + 의자 + "" + 블루 + " 傷害皮膚抽獎      #l#k\r\n\r\n";
        ...
        if (selection == 0) {
            ...
            cm.dispose();
} else if (selection == 16) { // 選擇皮諾啾與雪吉拉 
    var choose = "#fs15#" + 검정 + "在艾爾達斯與皮諾啾、雪吉拉一起冒險並領取獎勵吧！\r\n#r系統維護中，獎勵內容後續可能調整@@\r\n";
    choose += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
    choose += "#L30##i3801314# #fc0xFFF361A6#皮諾啾#k" + 검정 + " 培養獎勵確認#k#l\r\n"
    choose += "#L31##i3801315# #fc0xFF47C83E#雪吉拉#k" + 검정 + " 培養獎勵確認#k#l\r\n"
        ...
        if (sel == 4) { // 칭호 승급
            if (selection == 3) {
                ...
                말 = "#fs15#칭호 승급을 하기 위해선 아래의 조건이 필요하다네.\r\n"
                말 += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
                selching = selection;
                if (selching == 0) {
                    ssssitem = 4310012;
            ...
            if (selection == 5) {
                말 = "#fs15##i1182000# #b#z1182000##k 아이템을 제작하겠나?"
            ...
            if (selection == 22) {
                ...
                말 = "#fs15#" + 검정 + "페스티벌에서 다양한 점프맵도 준비해봤다네!\r\n"
                말 += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
        ...
        if (selection == 100) {
            ...
            if (sell == 5) {
                if (cm.getPlayer().getMeso() < 700000000 || !cm.haveItem(4310010, 50) || !cm.haveItem(4310012, 200)) { //재료체크
                    cm.sendOkS("#fs15##b#z1182000##k를 제작하기 위한 재료 아이템이 부족한거 같군.", 0x04, 2192030);
                    cm.dispose();
                    return;
                }
                if (Math.floor(Math.random() * 100) <= 50) { // 성공했을때
                    ...
                    말 = "#fs15#축하하네! 초월자의 힘에 다가가기 위한 첫걸음에 성공했네.\r\n\r\n"
                    ...
                    cm.gainItem(4310010, -50);
                    cm.gainItem(4310012, -200);
                    cm.sendOkS("#fs15##r아쉽게도 제작에 실패했다네..", 0x04, 2192030);
                    cm.dispose();
                    return;
                }
            } else if (sell == 6) {
                ...
                if (selection == 1) {
                    suc = 15;
                    말 = "#fs15##i1162000# #b#z1162000##k 아이템을 제작하겠나?"
                    말 += "\r\n제작을 하려면 아래의 재료가 필요하지.\r\n"
                    ...
                    suc = 15;
                    말 = "#fs15##i1162001# #b#z1162001##k 아이템을 제작하겠나?"
                    말 += "\r\n제작을 하려면 아래의 재료가 필요하지.\r\n"
                    if (cm.haveItem(4310009, 1)) { //확률업 체크
                        말 += "자네는 " + 블루 + "#z4310009##k을 보유하고 있군!\r\n";
                        suc += 15;
                    ...
                    suc = 30;
                    말 = "#fs15##i1162002# #b#z1162002##k 아이템을 제작하겠나?"
                    말 += "\r\n제작을 하려면 아래의 재료가 필요하지.\r\n"
                    말 += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
        ...
        if (sel == 5) {
            ...
            if (!cm.haveItem(needitem1, needitem1count)) { //재료체크
                cm.sendOkS("#fs15##b#z" + sucitemid + "##k를 제작하기 위한 재료 아이템이 부족한거 같군.", 0x04, 2192030);
                cm.dispose();
                return;
            }
            if (sel2 == 1) {
            ...
            if (sucss) { // 성공했을때
                ...
                txt = "";
                if (sel2 == 1 || sel2 == 2) {
                    txt += "#fs15##r아쉽게도 제작에 실패했다네..";
                } else {
                    txt += "#fs15#아쉽게도 제작에 실패했다네..\r\n\r\n"
        ...
        if (sel == 4) { //승급 연출
            ...
            if (succ) {
                ...
                cm.gainMeso(-meso);
                말 = "#fs15#블랙 페스티벌에서의 승급을 축하한다네!\r\n\r\n"
                말 += "#fUI/UIWindow2.img/QuestIcon/4/0#\r\n"
                말 += "#i" + rewarditemid + "##b#z" + rewarditemid + "##k";
                cm.sendOkS(말, 0x04, 2192030);
                cm.dispose();
            } else {
                말 = "#fs15#너무 상심하지 말게 #h #.. 다음엔 좋은 결과가 있을거라네..!\r\n\r\n"
                cm.gainItem(etc, -sale);
                cm.gainItem(etc1, -sale1);
                cm.gainMeso(-meso);
                cm.sendOkS(말, 0x04, 2192030);
