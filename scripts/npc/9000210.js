...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var msg ="#fs15##d현재 #h #님의 후원포인트 : #r"+cm.getPlayer().getDonationPoint()+"P#b"+enter;
		...
		switch (sel) {
			...
			case 3:
				...
				var msg = "원하는걸 골라보거라#fs15##b"+enter;
			...
			return;
				...
				msg += "#fUI/UIWindow8.img/EldaGauge/tooltip/46# 현재 #h #님의 후원포인트 : #r"+cm.getPlayer().getDonationPoint()+"P#k#fs15#"+enter+enter;
