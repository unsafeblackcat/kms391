...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var choose = "                    " + 틀 + "#l\r\n";
        choose += "#fs15##fc0xFFD5D5D5#──────────────────────────#k\r\n";
        choose += "#L6##fc0xFFFF3636#美容美髮變更#l";
        choose += "#L7##fc0xFFFF3636#美容美髮咨詢#l\r\n\r\n";
        choose += "#L8##fc0xFFFF3636#美容美髮搜索#l\r\n";
        ...
        if (selection == 1) { // 아이템 버리기
         ...
         cm.openNpc(1105008);
            ...
            cm.dispose();
            cm.openNpcCustom(cm.getClient(), 9000217, "MeiRongMeiFaBianGeng 2");
            ...
            cm.dispose();
            cm.openNpcCustom(cm.getClient(), 9063140, "MeiRongMeiFaChaXun");
        } else if (selection == 8) { //자유 전직
            cm.dispose();
            cm.openNpcCustom(cm.getClient(), 9063140, "MeiRongMeiFaBianGeng");
