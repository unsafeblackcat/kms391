...
function action(mode, type, selection) {
	...
	msg += "　　　　#L2##fc0xFFDF4D4D#" + 템버리기+ "일반 사냥터#l"; msg +=  "#L3##fc0xFFDF4D4D#" + 템버리기 +  "자동 사냥터#l\r\n\r\n";
		//msg += "#L2##fc0xFFF29661#" + 템버리기+ "일반 사냥터#l\r\n\r\n"; 
		msg += "\r\n#fc0xFF191919#───────────EVENT─────────#k\r\n";
		//msg += "#L2# #b일반 사냥터#n #k\r\n";
		//msg += "#L3# #b자동 사냥터#n #k\r\n\r\n";
		msg += "　　　　　　    #L6##fc0xFFDF4D4D#" + 템버리기+ "파티퀘스트 장소#l\r\n\r\n";		
		msg += "　　#L8##fc0xFF6B66FF#" + 템버리기+ "이벤트 점프맵#n #k";		msg += "　#L10##fc0xFF6B66FF#" + 템버리기+ "도박장 아케이드#l\r\n\r\n";
		...
		switch (ans_01) {
			...
			case 3:
				...
				selStr += "일반사냥터 \r\n";
				selStr += "#L2##fs11# #e#d구버전 일반 사냥터#n #k이동\r\n";
				selStr += "#L3# #e#d신버전 일반 사냥터[1]#n #k이동#l\r\n";
				selStr += "#L4# #e#d신버전 일반 사냥터[2]#n #k이동#l\r\n";
				selStr += "#L5# #e#d신버전 일반 사냥터[3]#n #k이동#l\r\n\r\n";
				selStr += "후원 사냥터 \r\n";
				selStr += "#L6# #e#d구버전 후원 사냥터#n #k이동\r\n";
				selStr += "#L7# #e#d신버전 후원 사냥터[1]#n #k이동\r\n";
				selStr += "#L8# #e#d신버전 후원 사냥터[2]#n #k이동\r\n";
				selStr += "#L9# #e#d신버전 후원 사냥터[3]#n #k이동\r\n";
				selStr += "#L10# #e#d신버전 후원 사냥터[4]#n #k이동\r\n";
