...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var choose = "#fn나눔고딕#[프레이] 성장시스템 입니다.#fs13##k\r\n";
        choose += "#fn나눔고딕#각종 컨텐츠들과 함께 즐거운 [프레이]되세요!#fs11##k\r\n";
        choose += "\r\n\r\n" + 연보 + "───────────────────────────#k\r\n";
        ...
        choose += "\r\n\r\n#fc0xFFD5D5D5#" + 연보 + "───────────────────────────#k\r\n";
        //choose += "#L2#" + 뎀스 + " #fc0xFF6799FF#안개 숲 수련장#l";
     //   choose += "#L18#" + 컨텐츠 + " #fc0xFF6799FF#[프레이]도감#l";
       // choose += "#L21##fc0xFF6B66FF#" + " 일일퀘스트코인[캐릭강화]#l";
        choose += "\r\n\r\n#fc0xFFD5D5D5#" + 연보 + "───────────────────────────#k\r\n";
        ...
        if (selection == 0) {
          ...
          /*  choose += "#fc0xFFD5D5D5#────────────어센틱 지역────────────#k\r\n";
			...
			cm.sendSimpleS(choose, 0x04, 3003101);
           // cm.sendSimpleS(choose, 0x04, 1540105); //원본 <-일퀘 코드
        } else if (selection == 2) {
            cm.dispose();
