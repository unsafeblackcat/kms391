...
var 고정보상 = [[5062005, 1], [5062503, 10], [4310266, 200], [4310237, 500], [4310308, 40], [4001129, 15], [4310010, 30], [5060048, 1], [2437760, 10]];
var 막타보상 = [[5062005, 1], [5062503, 10], [4310266, 200], [4310237, 500], [4310308, 40], [4001129, 15], [4310010, 30], [5060048, 1], [2437760, 10]];
var 판매아이템 = [[5062005, 1, 100], [5062503, 5, 50], [4001716, 3, 50], [4310266, 10, 100], [4310010, 50, 250]];
    ...
    if (status == 0) {
        if (보스맵 == cm.getPlayer().getMapId()) {
            ...
            if (cm.getPlayer().gethottimeboss() && cm.getPlayerCount(211070100) < 31 && cm.canHold(처치템 ,1)) {
                ...
                var text = "아직 #b#e월드보스 핫타임 이벤트#k#n가 시작되지 않았습니다. \r\n현재는 #r#e월드보스의 전리품#k#n#i" + 구매시필요아이템 + "#으로 상점을 이용할수 있는 시간입니다!\r\n어떤 아이템을 구매하시고 싶으세요?\r\n\r\n";
