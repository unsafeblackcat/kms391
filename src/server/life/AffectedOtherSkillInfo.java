...
public class AffectedOtherSkillInfo {
	...
	public static void loadFromWZData() {
		...
		MapleData effdata = MapleDataProviderFactory
				.getDataProvider(MapleDataProviderFactory.fileInWZPath("Skill.wz/MobSkill")).getData("211.img");
				...
				for (MapleData infos : info.getChildren()) {
					if (infos.getName().equals("affectedOtherSkill")) {
						for (MapleData infos1 : infos.getChildren()) {
							if (infos1.getName().equals("0") || infos1.getName().equals("1")
									|| infos1.getName().equals("2")) {
								...
								for (MapleData infos2 : infos1.getChildren()) {
									...
									AffectedOtherSkillInfo affectedOtherSkillInfo = new AffectedOtherSkillInfo(number2,
											i, j);
							...
							AffectedOtherSkillInfo AOS = new AffectedOtherSkillInfo(-1, affectedOtherSkillID,
									affectedOtherSkillLev);
