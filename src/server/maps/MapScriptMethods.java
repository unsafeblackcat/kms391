...
public class MapScriptMethods {
	...
	private static final String[] mulungEffects = new String[] { "무릉도장에 도전한 것을 후회하게 해주겠다! 어서 들어와봐!",
			"기다리고 있었다! 용기가 남았다면 들어와 보시지!", "배짱 하나는 두둑하군! 현명함과 무모함을 혼동하지말라고!", "무릉도장에 도전하다니 용기가 가상하군!",
			"패배의 길을 걷고싶다면 들어오라고!" };
	...
	private static enum onFirstUserEnter {
		...
		StageMsg_goddess, party6weatherMsg, StageMsg_juliet, StageMsg_romio, will_phase1, will_phase2, will_phase3,
		WUK_StageEnter, moonrabbit_mapEnter, Fenter_450004250, Fenter_450004150, astaroth_summon, boss_Ravana,
		boss_Ravana_mirror, killing_BonusSetting, killing_MapSetting, metro_firstSetting, balog_bonusSetting,
		balog_summon, easy_balog_summon, Sky_TrapFEnter, pyramidWeather, shammos_Fenter, PRaid_D_Fenter, PRaid_B_Fenter,
		summon_pepeking, Xerxes_summon, VanLeon_Before, cygnus_Summon, storymap_scenario, shammos_FStart,
		kenta_mapEnter, iceman_FEnter, iceman_Boss, Polo_Defence, prisonBreak_mapEnter, Visitor_Cube_poison,
		...
		MalayBoss_Int, mPark_summonBoss, hontale_boss1, hontale_boss2, queen_summon0, pierre_Summon1, pierre_Summon,
		banban_Summon, firstenter_bossBlackMage, dusk_onFirstUserEnter, first_SlimeNormal1, first_SlimeChaos1,
		first_kalosChaos1, JinHillah_onFirstUserEnter, enter_120, enter_121, NULL;
	...
	private static enum onUserEnter {
		...
		will_phase1_everyone, will_phase2_everyone, will_phase3_everyone, dunkel_timeRecord, dunkel_boss,
		JinHillah_onUserEnter, evanPromotion, PromiseDragon, evanTogether, incubation_dragon, TD_MC_Openning,
		TD_MC_gasi, TD_MC_title, magnus_enter_HP, Akayrum_ExpeditionEnter, bhb2_scEnterHp, bhb3_scEnterHp,
		cygnusJobTutorial, cygnusTest, Polo_Wave, Fritto_Eagle_Enter, Fritto_Egg_Enter, Fritto_Dancing_Enter, startEreb,
		enter_450004150, PinkBeenJob_Event, dojang_Msg, dojang_1st, reundodraco, undomorphdarco, explorationPoint,
		...
		check_count, Massacre_first, Massacre_result, aranTutorAlone, evanAlone, dojang_QcheckSet, enter_120, enter_121,
		JinHillah_onFirstUserEnter, enter_450011990, Sky_StageEnter, outCase, balog_buff, balog_dateSet, Sky_BossEnter,
		Sky_GateMapEnter, shammos_Enter, shammos_Result, shammos_Base, dollCave00, dollCave01, dollCave02, Sky_Quest,
		enterBlackfrog, onSDI, blackSDI, summonIceWall, metro_firstSetting, start_itemTake, findvioleta,
		pepeking_effect, TD_MC_keycheck, TD_MC_gasi2, in_secretroom, sealGarden, TD_NC_title, TD_neo_BossEnter,
		PRaid_D_Enter, PRaid_B_Enter, PRaid_Revive, PRaid_W_Enter, PRaid_WinEnter, PRaid_FailEnter, Resi_tutor10,
		Resi_tutor20, Resi_tutor30, Resi_tutor40, Resi_tutor50, Resi_tutor60, Resi_tutor70, Resi_tutor80,
		Resi_tutor50_1, summonSchiller, q31102e, q31103s, jail, VanLeon_ExpeditionEnter, cygnus_ExpeditionEnter,
		knights_Summon, TCMobrevive, mPark_stageEff, mPark_Enter, moonrabbit_takeawayitem, StageMsg_crack,
		shammos_Start, iceman_Enter, prisonBreak_1stageEnter, VisitorleaveDirectionMode, visitorPT_Enter,
		VisitorCubePhase00_Enter, visitor_ReviveMap, cannon_tuto_01, cannon_tuto_direction, cannon_tuto_direction1,
		cannon_tuto_direction2, userInBattleSquare, merTutorDrecotion00, merTutorDrecotion10, merTutorDrecotion20,
		merStandAlone, merOutStandAlone, merTutorSleep00, merTutorSleep01, merTutorSleep02, EntereurelTW, ds_tuto_ill0,
		ds_tuto_0_0, ds_tuto_1_0, ds_tuto_3_0, ds_tuto_3_1, ds_tuto_4_0, ds_tuto_5_0, ds_tuto_2_prep, ds_tuto_1_before,
		ds_tuto_2_before, ds_tuto_home_before, ds_tuto_ani, PTtutor000, enter_993014200, enter_993018200,
		enter_993021200, enter_993029200, enter_hungryMuto, enter_hungryMutoEasy, enter_hungryMutoHard, enter_450002024,
		enter_993001000, // 갓오컨 로비
		enter_pfTutorialStage, // 갓오컨 시작
		enter_910143000, enter_450004200, enter_993192002, enter_993192003, enter_993192004, enter_993192005,
		enter_993192006, enter_993192007, BloomingRace_reset, enter_993194001, enter_993194002, enter_993189100,
		enter_101070000, miniGameVS_Start, fireWolf_Enter, NULL;
	...
	public static void startScript_FirstUser(MapleClient c, String scriptName) {
		...
		case JinHillah_onFirstUserEnter: // 여기가 작동
			c.getPlayer().getMap().broadcastMessage(CField.enforceMSG("希拉會每隔一段時間削掉靈魂燃燒的蠟燭. 小心靈魂被奪走.", 254, 8000));
		...
		case first_SlimeChaos1: {
			c.getPlayer().getClient().getSession()
					.writeAndFlush(MobPacket.BossSlime.SlimePacket(9, c.getPlayer().getMap()));
			c.getPlayer().getClient().getSession()
					.writeAndFlush(MobPacket.BossSlime.SlimePacket(7, c.getPlayer().getMap()));
			break;
		}
			...
			Timer.EventTimer.getInstance().schedule(() -> {
				...
				if (c.getPlayer().getMapId() == 450013100 || c.getPlayer().getMapId() == 450017100) {
					c.getPlayer().getMap().broadcastMessage(
							CField.enforceMSG(chaosBMS + "爲了打敗黑魔法師，必須消滅護衛他的 " + chaosBMS + "創造和破壞騎士.", 265, 8000));
				} else if (c.getPlayer().getMapId() == 450013300 || c.getPlayer().getMapId() == 450017300) {
					c.getPlayer().getMap().broadcastMessage(
							CField.enforceMSG("終於 " + chaosBMS + "直接站在了黑魔法師的面前,讓我們全力以赴打敗他吧.", 265, 8000));
				} else if (c.getPlayer().getMapId() == 450013500 || c.getPlayer().getMapId() == 450017500) {
					c.getPlayer().getMap()
							.broadcastMessage(CField.enforceMSG("那個樣子好像得到了神的權能.卽使對方是神,也要爲大家在這裡封鎖.", 265, 8000));
				}
				if (c.getPlayer().getMapId() == 450013100 || c.getPlayer().getMapId() == 450017100) {
					c.getPlayer().getMap().broadcastMessage(CField.ImageTalkNpc(0, 4000, "이 지역에서 발생되는 공격은 " + chaosBMS
							+ "창조나 파괴의 저주를 거는 것 같다. 만약 두 저주가 동시에 걸린다면 #b큰 피해#k를 입으니 조심하자"));
				} else if (c.getPlayer().getMapId() == 450013300 || c.getPlayer().getMapId() == 450017300) {
					c.getPlayer().getMap().broadcastMessage(CField.ImageTalkNpc(0, 4000, "이 지역에서 발생되는 공격은 " + chaosBMS
							+ "창조나 파괴의 저주를 거는 것 같다. 만약 두 저주가 동시에 걸린다면 #b큰 피해#k를 입으니 조심하자"));
				} else if (c.getPlayer().getMapId() == 450013500 || c.getPlayer().getMapId() == 450017500) {
					c.getPlayer().getMap()
							.broadcastMessage(CField.ImageTalkNpc(3003902, 4000, "#face1#가자. 나는 복수를, 너는 세계를 지키는 거야."));
				} else if (c.getPlayer().getMapId() == 450013700 || c.getPlayer().getMapId() == 450017700) {
					c.getPlayer().getMap()
							.broadcastMessage(CField.ImageTalkNpc(0, 4000, "아무 것도 없는 공간…… 나 혼자 남은 것인가……"));
				} else if (c.getPlayer().getMapId() == 450013750 || c.getPlayer().getMapId() == 450017750) {
					c.getPlayer().getMap()
							.broadcastMessage(CField.ImageTalkNpc(0, 5000, chaosBMS + "창세의 알을 파괴하여 기나긴 싸움을 마무리 하자."));
				}
			}, 1000L);
			break;
		}
		...
		case StageMsg_crack: {
			...
			case 922010100: {
				c.getPlayer().getMap().startMapEffect(
						"\ucc28\uc6d0\uc758 \ub77c\uce20\uc640 \ucc28\uc6d0\uc758 \ube14\ub799\ub77c\uce20\ub97c \ubaa8\ub450 \ud574\uce58\uc6b0\uace0 \ucc28\uc6d0\uc758 \ud1b5\ud589\uc99d 20\uc7a5\uc744 \ubaa8\uc544\ub77c!",
						5120018);
				break;
			}
			case 922010600: {
				c.getPlayer().getMap().startMapEffect(
						"\uc228\uaca8\uc9c4 \uc0c1\uc790\uc758 \uc554\ud638\ub97c \ud480\uace0 \uaf2d\ub300\uae30\ub85c \uc62c\ub77c\uac00\ub77c.",
						5120018);
				break;
			}
			case 922010700: {
				c.getPlayer().getMap().startMapEffect(
						"\uc774 \uacf3\uc5d0 \uc788\ub294 \ub86c\ubc14\ub4dc\ub97c \ubaa8\ub450 \ubb3c\ub9ac\uce58\uc790!",
						5120018);
			...
			case 922010800: {
				c.getPlayer().getMap().startSimpleMapEffect(
						"\ubb38\uc81c\ub97c \ub4e3\uace0 \uc815\ub2f5\uc5d0 \ub9de\ub294 \uc0c1\uc790 \uc704\ub85c \uc62c\ub77c\uac00\ub77c!",
						5120018);
				break;
			}
			case 922010900: {
				c.getPlayer().getMap().startSimpleMapEffect(
						"\uc54c\ub9ac\uc0e4\ub974\ub97c \ubb3c\ub9ac\uccd0 \uc8fc\uc138\uc694!", 5120018);
				c.getPlayer().getMap().spawnMonsterWithEffectBelow(MapleLifeFactory.getMonster(9300012),
						new Point(704, 184), 15);
				break;
			}
			}
			break;
		...
		case will_phase1: {
			c.getPlayer().getMap()
					.broadcastMessage(CField.enforceMSG("要同時攻擊完全不同的兩個空間裏的威爾.收集月光使用的話,好像可以移動到令一邊.", 245, 7000));
			break;
		}
		case will_phase2: {
			c.getPlayer().getMap()
					.broadcastMessage(CField.enforceMSG("小心鏡子裏的眞面目.收集月光使用的話,好像可以暫時停止無法治癒的詛呪.", 245, 7000));
		...
		case will_phase3: {
			c.getPlayer().getMap().broadcastMessage(CField.enforceMSG("威爾好像是眞心的.收集月光使用的話,好像可以燒掉蜘蛛網.", 245, 7000));
			for (MapleMonster m : c.getPlayer().getMap().getAllMonster()) {
				if (m.getId() != 8880342 && m.getId() != 8880302) {
					continue;
				}
		...
		case party6weatherMsg: {
			...
			case 930000000: {
				c.getPlayer().getMap().startMapEffect(
						"\uc911\uc559\uc758 \ud3ec\ud0c8\uc744 \ud0c0\uace0 \uc785\uc7a5\ud574. \uc9c0\uae08 \ub108\uc5d0\uac8c \ubcc0\uc2e0 \ub9c8\ubc95\uc744 \uac78\uac8c.",
						5120023);
				break;
			}
			case 930000010: {
				c.getPlayer().getMap().startMapEffect(
						"\ubcf8\uc778\uc774 \ub204\uad70\uc9c0 \ud5f7\uac08\ub9ac\uc9c0 \uc54a\ub3c4\ub85d \uc790\uc2e0\uc758 \ubaa8\uc2b5\uc744 \ud655\uc778\ud574!",
						5120023);
				break;
			}
			case 930000100: {
				c.getPlayer().getMap().startMapEffect(
						"\ud2b8\ub9ac\ub85c\ub4dc \ub54c\ubb38\uc5d0 \uc232\uc774 \ub3c5\uc5d0 \uc624\uc5fc\ub418\uc5c8\uc5b4. \ud2b8\ub9ac\ub85c\ub4dc\ub97c \ubaa8\ub450 \uc5c6\uc560\uc918!",
						5120023);
				break;
			}
			case 930000200: {
				c.getPlayer().getMap().startMapEffect(
						"\uc6c5\ub369\uc774\uc5d0\uc11c \ub3c5\uc744 \ud76c\uc11d\ub41c \ub3c5\uc73c\ub85c \ubc14\uafb8\uace0, \ud76c\uc11d\ub41c \ub3c5\uc73c\ub85c \uac00\uc2dc\ub364\ubd88\uc744 \uc5c6\uc560!",
						5120023);
				break;
			}
			case 930000300: {
				c.getPlayer().getMap().startMapEffect(
						"\ub2e4\ub4e4 \uc5b4\ub514 \uac00\ubc84\ub9b0\uac70\uc57c? \ud3ec\ud0c8\uc744 \ud0c0\uace0 \ub0b4\uac00 \uc788\ub294 \uacf3\uae4c\uc9c0 \uc640!",
						5120023);
				break;
			}
			case 930000400: {
				c.getPlayer().getMap().startMapEffect(
						"\uc911\ub3c5\ub41c \uc2a4\ud504\ub77c\uc774\ud2b8\ub97c \ubb3c\ub9ac\uce58\uace0 \ubaac\uc2a4\ud130 \uad6c\uc2ac\uc744 \ubaa8\uc544\uc640\uc918!",
						5120023);
				break;
			}
			case 930000500: {
				c.getPlayer().getMap().startMapEffect(
						"\uad34\uc778\uc758 \ucc45\uc0c1 \uc55e\uc5d0 \uc788\ub294 \uc0c1\uc790\ub4e4\uc744 \uc5f4\uace0 \ubcf4\ub77c\uc0c9 \ub9c8\ub825\uc11d\uc744 \uac00\uc838\uc640!",
						5120023);
				break;
			}
			case 930000600: {
				c.getPlayer().getMap().startMapEffect(
						"\ubcf4\ub77c\uc0c9 \ub9c8\ub825\uc11d\uc744 \uac00\uc9c0\uace0 \uad34\uc778\uc758 \ucc45\uc0c1\uc744 \ud074\ub9ad\ud574 \ubd10!",
						5120023);
				break;
			}
			}
		...
		case WUK_StageEnter: {
			...
			case 933011000: {
				c.getPlayer().getMap().startMapEffect(
						"\ud30c\ud2f0\uc6d0\ub4e4\uc740 \ud074\ub85c\ud1a0\ub97c \ucc3e\uc544\uac00\uc11c \uadf8\ub140\uac00 \ub9d0\ud55c \uac1c\uc218\ub9cc\ud07c \ub9ac\ucf00\uc774\ud130\ub97c \ubb3c\ub9ac\uce58\uace0 \ucfe0\ud3f0\uc744 \ubaa8\uc544\ub77c!",
						5120017);
				break;
			}
			case 933012000: {
				c.getPlayer().getMap().startMapEffect(
						"\ub2e4\uc74c \ub2e8\uacc4\ub85c \uac00\ub294 \ubb38\uc744 \uc5f4 \uc218 \uc788\ub294 \uc904 3\uac1c\ub97c \ucc3e\uc544\uc11c \ub9e4\ub2ec\ub824\ub77c!",
						5120017);
			...
			case 933013000: {
				c.getPlayer().getMap().startMapEffect(
						"\ub2e4\uc74c \ub2e8\uacc4\ub85c \uac00\ub294 \ubb38\uc744 \uc5f4 \uc218 \uc788\ub294 \ubc1c\ud310 3\uac1c\ub97c \ucc3e\uc544\ub77c!",
						5120017);
			...
			case 933015000: {
				...
				c.getPlayer().getMap().startMapEffect("\ud0b9\uc2ac\ub77c\uc784\uc744 \ud574\uce58\uc6cc\ub77c!!",
						5120017);
				break;
			}
			}
		...
		case prisonBreak_mapEnter: {
			...
			case 921160200: {
				c.getPlayer().getMap().startMapEffect(
						"\uacbd\ube44\ubcd1\ub4e4\uc744 \ubaa8\ub450 \ubb3c\ub9ac\uce58\uc154\uc57c \ud574\uc694. \uadf8\ub807\uc9c0 \uc54a\uc73c\uba74 \uadf8\ub4e4\uc774 \ub2e4\ub978 \uacbd\ube44\ubcd1\uae4c\uc9c0 \ubd88\ub7ec\uc62c\uaebc\uc5d0\uc694.",
						5120053);
			...
			case 921160300: {
				c.getPlayer().getMap().startMapEffect(
						"\uac10\uc625\uc73c\ub85c\uc758 \uc811\uadfc\uc744 \ub9c9\uae30 \uc704\ud574 \uadf8\ub4e4\uc774 \ubbf8\ub85c\ub97c \ub9cc\ub4e4\uc5b4 \ub1a8\uc5b4\uc694. \uacf5\uc911\uac10\uc625\uc73c\ub85c \ud1b5\ud558\ub294 \ubb38\uc744 \ucc3e\uc73c\uc138\uc694!",
						5120053);
			...
			case 921160500: {
				c.getPlayer().getMap().startMapEffect(
						"\uc774\uac83\uc774 \ub9c8\uc9c0\ub9c9 \uc7a5\uc560\ubb3c\uc774\uad70\uc694. \uc7a5\uc560\ubb3c\uc744 \ud1b5\uacfc\ud574 \uacf5\uc911 \uac10\uc625\uc73c\ub85c \uc640\uc8fc\uc138\uc694.",
						5120053);
				c.getPlayer().getMap().broadcastMessage(CField.achievementRatio(50));
				break;
			}
			...
			case 921160700: {
				...
				c.getPlayer().getMap().startMapEffect(
						"\uad50\ub3c4\uad00\uc744 \ubb3c\ub9ac\uce58\uace0 \uc6b0\ub9ac\uc5d0\uac8c \uc790\uc720\ub97c \ub418\ucc3e\uc544\uc8fc\uc138\uc694!!!",
						5120053);
				c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeFactory.getMonster(9300454),
						new Point(-954, -181));
				break;
			}
			}
		...
		case pyramidWeather: {
			...
			for (MapleNettPyramid.MapleNettPyramidMember pm : mnp.getMembers()) {
				if (pm.getChr() != null) {
					int v = pm.getChr().getV("NettPyramid") == null ? 0
							: Integer.parseInt(pm.getChr().getV("NettPyramid"));
		...
		default: {
                FileoutputUtil.log("Log_Script_Except.txt", "未處理的腳本 : " + scriptName
        + ", 類型 : onFirstUserEnter - 地圖ID " + c.getPlayer().getMapId());
		}
		}
	}
	...
	public static void startScript_User(final MapleClient c, final String scriptName) {
		...
		case enter_120: {
			c.getPlayer().getClient().getSession()
					.writeAndFlush(SLFCGPacket.PoloFrittoEffect(4, "Effect/EventEffect.img/SalonDebut/screenEff/1366"));
			c.getPlayer().getClient().getSession()
					.writeAndFlush(SLFCGPacket.BlackLabel("#fs11##eWelcome :: Fancy 서버", 100, 1000, 4, 0, -250, 1, 4));
		}
			break;
		...
		case dojang_1st: {
			c.getPlayer().getMap().startMapEffect(
					"\uc81c\ud55c\uc2dc\uac04\uc740 15\ubd84, \ucd5c\ub300\ud55c \uc2e0\uc18d\ud558\uac8c \ubaac\uc2a4\ud130\ub97c \uc4f0\ub7ec\ud2b8\ub9ac\uace0 \ub2e4\uc74c \uce35\uc73c\ub85c \uc62c\ub77c\uac00\uba74 \ub3fc!",
					5120024, 8000);
			break;
		}
		...
		case dunkel_timeRecord: {
			...
			c.getPlayer().getMap().broadcastMessage(CField.enforceMSG(
					"\uce5c\uc704\ub300\uc7a5 \ub4c4\ucf08 : \ub098\uc640 \ub098\uc758 \uad70\ub2e8\uc774 \uc788\ub294 \uc774\uc0c1 \uc704\ub300\ud558\uc2e0 \ubd84\uaed8\ub294 \uc190\ub05d \ud558\ub098 \ub300\uc9c0 \ubabb\ud55c\ub2e4!",
					272, 5000));
			break;
		}
		case cannon_tuto_direction1: {
			...
			c.getSession().writeAndFlush((Object) CField.UIPacket
			...
			c.getSession().writeAndFlush(
					(Object) CField.EffectPacket.showWZEffect("Effect/Direction4.img/cannonshooter/face04"));
			c.getSession().writeAndFlush(
					(Object) CField.EffectPacket.showWZEffect("Effect/Direction4.img/cannonshooter/out01"));
		...
		case magnus_enter_HP: {
			if (c.getPlayer().getMap().getNumMonsters() == 0) {
				final MapleMonster magnus = MapleLifeFactory
						.getMonster((c.getPlayer().getMapId() == 401060300) ? 8880010
								: ((c.getPlayer().getMapId() == 401060200) ? 8880002 : 8880000));
		...
		case bhb3_scEnterHp: {
			if (c.getPlayer().getMap().getNumMonsters() == 0) {
				c.getPlayer().getMap().spawnMonsterOnGroundBelow(
						MapleLifeFactory.getMonster((c.getPlayer().getMapId() == 350060190) ? 8950101
								: ((c.getPlayer().getMapId() == 350060210) ? 8950102
										: ((c.getPlayer().getMapId() == 350060200) ? 8950002 : 8950001))),
		...
		case Akayrum_ExpeditionEnter: {
			if (c.getPlayer().getMap().getNumMonsters() == 0) {
				c.getPlayer().getMap()
						.broadcastMessage(CField.EffectPacket.showEffect(c.getPlayer(), 0, 0, 34, 0, 0,
								(byte) (c.getPlayer().isFacingLeft() ? 1 : 0), false, c.getPlayer().getTruePosition(),
								"Voice.img/akayrum/2", null));
				c.getPlayer().getMap().broadcastMessage(CField.startMapEffect(
						"\uc6a9\uae30\uc640 \ub9cc\uc6a9\uc744 \uad6c\ubd84\ud558\uc9c0 \ubabb\ud558\ub294 \uc790\ub4e4\uc774\uc5ec. \ubaa9\uc228\uc774 \uc544\uae5d\uc9c0 \uc54a\ub2e4\uba74 \ub0b4\uac8c \ub364\ube44\ub3c4\ub85d. \ud6c4\ud6c4.",
						5120056, true));
		...
		case Resi_tutor30: {
			c.getSession().writeAndFlush((Object) CField.EffectPacket
					.showWZEffect("Effect/OnUserEff.img/guideEffect/resistanceTutorial/userTalk"));
			break;
		}
		case Resi_tutor40: {
			NPCScriptManager.getInstance().dispose(c);
		...
		case merTutorDrecotion10: {
			...
			c.getSession().writeAndFlush((Object) CField.UIPacket
					.getDirectionInfo("Effect/Direction5.img/effect/mercedesInIce/merBalloon/6", 2000, 0, -100, 1, 0));
		...
		case dojang_Msg: {
			c.getPlayer().getMap().startMapEffect(
					MapScriptMethods.mulungEffects[Randomizer.nextInt(MapScriptMethods.mulungEffects.length)], 5120024);
			break;
		}
		case undomorphdarco:
		case reundodraco: {
		...
		case mPark_stageEff: {
			c.getPlayer().dropMessage(-1,
					"\ud544\ub4dc \ub0b4\uc758 \ubaa8\ub4e0 \ubaac\uc2a4\ud130\ub97c \uc81c\uac70\ud574\uc57c \ub2e4\uc74c \uc2a4\ud14c\uc774\uc9c0\ub85c \uc774\ub3d9\ud558\uc2e4 \uc218 \uc788\uc2b5\ub2c8\ub2e4.");
			...
			case 3: {
				...
				c.getSession().writeAndFlush((Object) CField
						.showEffect("monsterPark/stageEff/number/" + (c.getPlayer().getMapId() % 1000 / 100 + 1)));
				break;
			}
			case 4: {
		...
		case TD_NC_title: {
			...
			case 6: {
				c.getSession().writeAndFlush(
						(Object) CField.MapEff("temaD/enter/neoCity" + c.getPlayer().getMapId() / 100 % 10));
				break;
			}
			}
			break;
		...
		case explorationPoint: {
			...
			if (c.getPlayer().getMapId() == 104000000) {// 检查玩家当前所在地图ID是否为104000000（明珠港）
				c.getSession().writeAndFlush((Object) CField.UIPacket.IntroDisableUI(false));// 启用用户界面交互（取消禁用UI状态）
				c.getSession().writeAndFlush((Object) CWvsContext.enableActions(c.getPlayer()));// 允许玩家进行移动、攻击等操作
				c.getSession().writeAndFlush((Object) CField.MapNameDisplay(c.getPlayer().getMapId())); // 在界面显示当前地图名称

				// c.getSession().writeAndFlush((Object) CField.UIPacket.IntroLock(false)); //
				// 這段代碼會導致自動打開6轉技能UI界面 因此不被引用
			}
			MapleQuest.MedalQuest m = null;// 初始化勋章任务变量
			for (final MapleQuest.MedalQuest mq : MapleQuest.MedalQuest.values()) { // 遍历所有勋章任务枚举值
				for (final int j : mq.maps) {// 遍历当前勋章任务关联的所有地图ID
					if (c.getPlayer().getMapId() == j) {// 检查玩家当前地图ID是否匹配勋章任务地图
						m = mq;// 匹配成功时记录当前勋章任务
						break;
					}
				}
			...
			if (m != null && c.getPlayer().getLevel() >= m.level && c.getPlayer().getQuestStatus(m.questid) != 2) {
				...
				if (changedd) {
					...
					c.getPlayer().dropMessage(-1,
							"\uce6d\ud638 - " + m.questname + " \ud0d0\ud5d8\uac00 \ub3c4\uc804 \uc911");
					c.getSession()
							.writeAndFlush((Object) CWvsContext.showQuestMsg("",
									"\uce6d\ud638 - " + m.questname + " \ud0d0\ud5d8\uac00 \ub3c4\uc804 \uc911. "
											+ number + "/" + m.maps.length + "\uac1c \uc9c0\uc5ed \uc644\ub8cc"));
				}
				break;
			}
			break;
		...
		case ds_tuto_3_1: {
			...
			c.getSession().writeAndFlush((Object) CField.UIPacket
					.getDirectionInfo("Effect/Direction5.img/effect/tuto/balloonMsg2/0", 2000, 0, -100, 1, 0));
			c.getSession().writeAndFlush((Object) CField.UIPacket
					.getDirectionInfo("Effect/Direction5.img/effect/tuto/balloonMsg1/3", 2000, 0, -100, 1, 0));
			Timer.EventTimer.getInstance().schedule(new Runnable() {
				@Override
				public void run() {
					c.getSession().writeAndFlush((Object) CField.UIPacket.getDirectionInfo(3, 0));
		...
		case iceCave: {
			...
			c.getPlayer().changeSkillsLevel(sa);
			c.getSession().writeAndFlush(
					(Object) CField.EffectPacket.showWZEffect("Effect/Direction1.img/aranTutorial/ClickLirin"));
			c.getSession().writeAndFlush((Object) CField.UIPacket.IntroDisableUI(false));
			c.getSession().writeAndFlush((Object) CField.UIPacket.IntroLock(false));
			c.getSession().writeAndFlush((Object) CWvsContext.enableActions(c.getPlayer()));
			break;
		...
		case rienArrow: {
			if (c.getPlayer().getInfoQuest(21019).equals("miss=o;helper=clear")) {
				...
				c.getSession().writeAndFlush((Object) CField.EffectPacket
						.showWZEffect("Effect/OnUserEff.img/guideEffect/aranTutorial/tutorialArrow3"));
				break;
			}
			break;
		}
		...
		case PTtutor000: {
			try {
				...
				c.getSession().writeAndFlush((Object) CField.UIPacket.getDirectionInfo(3, 1));
				c.getSession().writeAndFlush((Object) CField.UIPacket
						.getDirectionInfo("Effect/Direction6.img/effect/tuto/balloonMsg0/10", 0, 0, -110, 1, 0));
				Thread.sleep(1300L);
		...
		case enter_993029200: {
			...
			if (c.getPlayer().getV("linkMob") != null && count > 0) {
				final int[] smobid = { 9010152, 9010153, 9010154, 9010155, 9010156, 9010157, 9010158, 9010159, 9010160,
						9010161, 9010162, 9010163, 9010164, 9010165, 9010166, 9010167, 9010168, 9010169, 9010170,
						9010171, 9010172, 9010173, 9010174, 9010175, 9010176, 9010177, 9010178, 9010179, 9010180,
						9010181 };
		...
		case fireWolf_Enter: {
			...
			c.getSession().writeAndFlush((Object) CField.startMapEffect(
					"\ubd88\uaf43\ub291\ub300\ub97c \ucc98\uce58\ud560 \uc6a9\uc0ac\uac00 \ub298\uc5c8\uad70. \uc5b4\uc11c \ub140\uc11d\uc744 \uacf5\uaca9\ud574! \uba38\ubb34\ub97c \uc218 \uc788\ub294 \uc2dc\uac04\uc740 30\ucd08 \ubfd0\uc774\uc57c!",
					5120159, true));
		...
		case enter_101070000: {
			c.getPlayer().getClient().getSession()
					.writeAndFlush(CField.environmentChange("Map/Effect.img/temaD/enter/fairyAcademy", 19));
			break;
		}
		case enter_993189100: {
			// c.getSession().writeAndFlush(SLFCGPacket.OnYellowDlg(9062004, 3000, "#b"+
			// c.getPlayer().getName() +"님#k #face1#오늘도 Fancy에서 좋은 하루 되세요.", ""));
			c.getPlayer().getClient().getSession()
					.writeAndFlush(SLFCGPacket.BlackLabel("#fs11##eWelcome :: Fancy 서버", 100, 1000, 4, 0, -250, 1, 4));
			break;
...
FileoutputUtil.log("Log_Script_Except.txt",
        "未處理的腳本 : " + scriptName + ", 類型 : onUserEnter - 地圖ID " + c.getPlayer().getMapId());
			break;
		}
		}
		switch (scriptName) {
	...
	private static void sendDojoClock(MapleClient c) {
		c.getSession().writeAndFlush(CField.getDojoClock(900,
				(int) ((System.currentTimeMillis() - c.getPlayer().getDojoStartTime() - c.getPlayer().getDojoCoolTime())
						/ 1000L)));
	}
			...
			if (start) {
				...
				for (String s : di.eventQ) {
					...
					case merTutorDrecotion01:
						c.getSession().writeAndFlush(CField.UIPacket.getDirectionInfo(
					...
					case merTutorDrecotion05:
						...
						Timer.EventTimer.getInstance().schedule(new Runnable() {
							public void run() {
								...
								c.getSession().writeAndFlush(CField.UIPacket.getDirectionStatus(true));
								c.getSession()
										.writeAndFlush(CField.UIPacket.getDirectionInfo(
