...
public class Obstacle extends MapleMapObject {
	...
	public Obstacle(int key, Point pos1, Point pos2, int range, int trueDamage, int height, int MaxP, int length,
			int angle, int unk) {
		this.key = key;
	...
	public Obstacle(int key, Point pos1, Point pos2, int range, int trueDamage, int dealy, int height, int MaxP,
			int length, int angle, int unk) {
		this.key = key;
		this.oldPosition = pos1;
		this.newPosition = pos2;
		this.range = range;
