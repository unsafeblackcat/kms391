...
public class NPCAutoWriterHelper {
	...
	public static final String getNPCName(int id) {
		return MapleDataTool.getString(id + "/name",
				MapleDataProviderFactory.getDataProvider(new File("wz/String.wz")).getData("Npc.img"), "MISSINGNO");
	}
	...
	public final String getNpcName() {
		return MapleDataTool.getString(this.npcID + "/name",
				MapleDataProviderFactory.getDataProvider(new File("wz/String.wz")).getData("Npc.img"), "MISSINGNO");
	}

	public final String getNpcFunc() {
		return MapleDataTool.getString(this.npcID + "/func",
				MapleDataProviderFactory.getDataProvider(new File("wz/String.wz")).getData("Npc.img"), "MISSINGNO");
	}
	...
	public final String addInfo(int id) {
		...
		a = a + "\r\n#k";
		for (MapleData d : MapleDataProviderFactory.getDataProvider(new File("wz/String.wz")).getData("Npc.img")
