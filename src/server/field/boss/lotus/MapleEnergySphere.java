...
public class MapleEnergySphere extends MapleMapObject {
	...
	public MapleEnergySphere(boolean isDelayed, int size, int y, int density, int friction, int destroyDelay,
			int startDelay) {
		setOk(true);
	...
	public MapleEnergySphere(boolean isDelayed, int size, int y, int density, int friction, int destroyDelay,
			int startDelay, List<Integer> pointx, int num) {
		setOk(true);
		setDelayed(isDelayed);
		setY(y);
		setDensity(density);
	...
	public MapleEnergySphere(int x, int retitution, int destroyDelay, int startDelay, boolean noGravity,
			boolean noDeleteFromOthers) {
		setOk(false);
		setX(x);
