...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        text = "#e#dPixi 用戶 #h 0##k#n 您好～隨時歡迎光臨！請選擇要兌換的物品。#b\r\n\r\n";
        for (var i = 0; i < 6; i++) {
            text += "#L" + i + "# #i" + (2431968 + i) + "# #z" + (2431968 + i) + ":#\r\n(重生點數 100,000) #l\r\n";
        }
        text += "#L6##i5680151##z5680151:# (重生點數 1,000)#l\r\n";
        text += "#L7##i5680148##z5680148:# (重生點數 5,000)#l\r\n";
        text += "#L8##i5680149##z5680149:# (重生點數 10,000)#l\r\n";
        text += "#L9##i5680150##z5680150:# (重生點數 30,000)#l\r\n";
        text += "#L10##i5680193##z5680193:# (重生點數 50,000)#l\r\n";
        text += "#L11##i5680194##z5680194:# (重生點數 100,000)#l\r\n";
        cm.sendSimple(text); 
    } else if (status == 1) {
        cm.dispose(); 
        if (selection < 6) {
            ...
            if (cm.getPlayer().getKeyValue(1,  "reborns") < 30000) {  // 修正數值錯誤（原版3000→30000）
                cm.sendOk(" 重生點數不足。");
                return;
            } else {
