...
public class MapleSummon extends AnimatedMapleMapObject {
	...
	public MapleSummon(MapleCharacter owner, int sourceid, Point pos, SummonMovementType movementType, byte rltype,
			int duration) {
		this.owner = owner;
		this.skill = sourceid;
	...
	public final boolean isMultiAttack() {
		if (this.skill != 35111002 && this.skill != 35121003 && this.skill != 61111002 && this.skill != 61111220
				&& (isGaviota() || this.skill == 33101008 || this.skill >= 35000000) && this.skill != 35111009
				&& this.skill != 35111010 && this.skill != 35111001) {
			return false;
		}
		return true;
	}
