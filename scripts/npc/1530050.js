...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		choose += "#L1##b" + 버리기 + "刪除物品#l";
		choose += "#L3##b" + 길드 + "傳送工會#l";
                choose += "#L0##b" + 펫 + "獲得寵物   #l\r\n";
		choose += "#L4##fc0xFF2F9D27#" + 버리기 + "機械偉裝#l";
		choose += "#L5##fc0xFF2F9D27#" + 길드 + "使用倉庫#l";
		choose += "#L6##fc0xFF2F9D27#" + 펫 + "特殊技能#l\r\n\r\n";
		choose += "#fc0xFFD5D5D5#──────────────────────────#k\r\n";
		choose += "#L7##fc0xFFFF3636#一鍵魔方#l";
		choose += "#L8##fc0xFFFF3636#一鍵退款#l";
		choose += "#L9##fc0xFFFF3636#一鍵强化#l\r\n\r\n";
		choose += "#fc0xFFD5D5D5#──────────────────────────#k\r\n\r\n";
		choose += "#L10##fc0xFF660058#■  幻影鋼鐵技能#k 使用.#l\r\n";
		choose += "#L11##fc0xFF660058#■  抽取系統#k 使用.#l\r\n";
		choose += "#L12##fc0xFF660058#■  快遞系統#k 使用.#l\r\n";
