...
public class EquipmentEnchant {
	...
	public static List<EquipmentScroll> equipmentScrolls(Equip equip) {
		...
		if (equip.getUpgradeSlots() > 0) {
			/*
			 * //修改記錄？？注釋掉了一段關於卷軸的較長代碼 if (GameConstants.isWeapon(equip.getItemId())) { if
			 * (isMagicWeapon(weaponType)) { if (reqLevel < 80) { stats.add(new
			 * Pair<>(EnchantFlag.Matk, Integer.valueOf(1))); } else if (reqLevel < 120) {
			 * stats.add(new Pair<>(EnchantFlag.Matk, Integer.valueOf(2))); } else {
			 * stats.add(new Pair<>(EnchantFlag.Matk, Integer.valueOf(3))); } ess.add(new
			 * EquipmentScroll("100% 마력 주문서", usejuhun[0], stats)); stats.clear(); if
			 * (reqLevel < 80) { stats.add(new Pair<>(EnchantFlag.Matk,
			 * Integer.valueOf(2))); ess.add(new EquipmentScroll("70% 마력 주문서", usejuhun[1],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Matk,
			 * Integer.valueOf(3))); stats.add(new Pair<>(EnchantFlag.Int,
			 * Integer.valueOf(1))); ess.add(new EquipmentScroll("30% 마력(지력) 주문서",
			 * usejuhun[2], stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Matk,
			 * Integer.valueOf(5))); stats.add(new Pair<>(EnchantFlag.Int,
			 * Integer.valueOf(2))); ess.add(new EquipmentScroll("15% 마력(지력) 주문서",
			 * usejuhun[3], stats)); stats.clear(); } else if (reqLevel < 120) {
			 * stats.add(new Pair<>(EnchantFlag.Matk, Integer.valueOf(3))); stats.add(new
			 * Pair<>(EnchantFlag.Int, Integer.valueOf(1))); ess.add(new
			 * EquipmentScroll("70% 마력(지력) 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Matk, Integer.valueOf(5))); stats.add(new
			 * Pair<>(EnchantFlag.Int, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("30% 마력(지력) 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Matk, Integer.valueOf(7))); stats.add(new
			 * Pair<>(EnchantFlag.Int, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("15% 마력(지력) 주문서", usejuhun[3], stats)); stats.clear(); } else
			 * { stats.add(new Pair<>(EnchantFlag.Matk, Integer.valueOf(5))); stats.add(new
			 * Pair<>(EnchantFlag.Int, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("70% 마력(지력) 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Matk, Integer.valueOf(7))); stats.add(new
			 * Pair<>(EnchantFlag.Int, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("30% 마력(지력) 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Matk, Integer.valueOf(9))); stats.add(new
			 * Pair<>(EnchantFlag.Int, Integer.valueOf(4))); ess.add(new
			 * EquipmentScroll("15% 마력(지력) 주문서", usejuhun[3], stats)); stats.clear(); } }
			 * else { if (reqLevel < 80) { stats.add(new Pair<>(EnchantFlag.Watk,
			 * Integer.valueOf(1))); } else if (reqLevel < 120) { stats.add(new
			 * Pair<>(EnchantFlag.Watk, Integer.valueOf(2))); } else { stats.add(new
			 * Pair<>(EnchantFlag.Watk, Integer.valueOf(3))); } ess.add(new
			 * EquipmentScroll("100% 공격력 주문서", usejuhun[0], stats)); stats.clear(); if
			 * (reqLevel < 80) { stats.add(new Pair<>(EnchantFlag.Watk,
			 * Integer.valueOf(2))); ess.add(new EquipmentScroll("70% 공격력 주문서", usejuhun[1],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Watk,
			 * Integer.valueOf(3))); stats.add(new Pair<>(EnchantFlag.Str,
			 * Integer.valueOf(1))); ess.add(new EquipmentScroll("30% 공격력(힘) 주문서",
			 * usejuhun[2], stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Watk,
			 * Integer.valueOf(5))); stats.add(new Pair<>(EnchantFlag.Str,
			 * Integer.valueOf(2))); ess.add(new EquipmentScroll("15% 공격력(힘) 주문서",
			 * usejuhun[3], stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Watk,
			 * Integer.valueOf(3))); stats.add(new Pair<>(EnchantFlag.Dex,
			 * Integer.valueOf(1))); ess.add(new EquipmentScroll("30% 공격력(민첩) 주문서",
			 * usejuhun[2], stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Watk,
			 * Integer.valueOf(5))); stats.add(new Pair<>(EnchantFlag.Dex,
			 * Integer.valueOf(2))); ess.add(new EquipmentScroll("15% 공격력(민첩) 주문서",
			 * usejuhun[3], stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Watk,
			 * Integer.valueOf(3))); stats.add(new Pair<>(EnchantFlag.Luk,
			 * Integer.valueOf(1))); ess.add(new EquipmentScroll("30% 공격력(행운) 주문서",
			 * usejuhun[2], stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Watk,
			 * Integer.valueOf(5))); stats.add(new Pair<>(EnchantFlag.Luk,
			 * Integer.valueOf(2))); ess.add(new EquipmentScroll("15% 공격력(행운) 주문서",
			 * usejuhun[3], stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Watk,
			 * Integer.valueOf(3))); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(50))); ess.add(new EquipmentScroll("30% 공격력(체력) 주문서",
			 * usejuhun[2], stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Watk,
			 * Integer.valueOf(5))); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(100))); ess.add(new EquipmentScroll("15% 공격력(체력) 주문서",
			 * usejuhun[3], stats)); stats.clear(); } else if (reqLevel < 120) {
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(3))); stats.add(new
			 * Pair<>(EnchantFlag.Str, Integer.valueOf(1))); ess.add(new
			 * EquipmentScroll("70% 공격력(힘) 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(5))); stats.add(new
			 * Pair<>(EnchantFlag.Str, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("30% 공격력(힘) 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(7))); stats.add(new
			 * Pair<>(EnchantFlag.Str, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("15% 공격력(힘) 주문서", usejuhun[3], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(3))); stats.add(new
			 * Pair<>(EnchantFlag.Dex, Integer.valueOf(1))); ess.add(new
			 * EquipmentScroll("70% 공격력(민첩) 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(5))); stats.add(new
			 * Pair<>(EnchantFlag.Dex, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("30% 공격력(민첩) 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(7))); stats.add(new
			 * Pair<>(EnchantFlag.Dex, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("15% 공격력(민첩) 주문서", usejuhun[3], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(3))); stats.add(new
			 * Pair<>(EnchantFlag.Luk, Integer.valueOf(1))); ess.add(new
			 * EquipmentScroll("70% 공격력(행운) 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(5))); stats.add(new
			 * Pair<>(EnchantFlag.Luk, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("30% 공격력(행운) 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(7))); stats.add(new
			 * Pair<>(EnchantFlag.Luk, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("15% 공격력(행운) 주문서", usejuhun[3], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(3))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(50))); ess.add(new
			 * EquipmentScroll("70% 공격력(체력) 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(5))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(100))); ess.add(new
			 * EquipmentScroll("30% 공격력(체력) 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(7))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(150))); ess.add(new
			 * EquipmentScroll("15% 공격력(체력) 주문서", usejuhun[3], stats)); stats.clear(); }
			 * else { stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(5)));
			 * stats.add(new Pair<>(EnchantFlag.Str, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("70% 공격력(힘) 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(7))); stats.add(new
			 * Pair<>(EnchantFlag.Str, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("30% 공격력(힘) 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(9))); stats.add(new
			 * Pair<>(EnchantFlag.Str, Integer.valueOf(4))); ess.add(new
			 * EquipmentScroll("15% 공격력(힘) 주문서", usejuhun[3], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(5))); stats.add(new
			 * Pair<>(EnchantFlag.Dex, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("70% 공격력(민첩) 주문서", usejuhun[1], stats)); stats.clear();
			 ...
			 * EquipmentScroll("30% 공격력(민첩) 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(9))); stats.add(new
			 * Pair<>(EnchantFlag.Dex, Integer.valueOf(4))); ess.add(new
			 * EquipmentScroll("15% 공격력(민첩) 주문서", usejuhun[3], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(5))); stats.add(new
			 * Pair<>(EnchantFlag.Luk, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("70% 공격력(행운) 주문서", usejuhun[1], stats)); stats.clear();
			 ...
			 * EquipmentScroll("30% 공격력(행운) 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(9))); stats.add(new
			 * Pair<>(EnchantFlag.Luk, Integer.valueOf(4))); ess.add(new
			 * EquipmentScroll("15% 공격력(행운) 주문서", usejuhun[3], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(5))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(100))); ess.add(new
			 * EquipmentScroll("70% 공격력(체력) 주문서", usejuhun[1], stats)); stats.clear();
			 ...
			 * EquipmentScroll("30% 공격력(체력) 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(9))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(200))); ess.add(new
			 * EquipmentScroll("15% 공격력(체력) 주문서", usejuhun[3], stats)); stats.clear(); } } }
			 * else if (equip.getItemId() / 10000 == 108) { if (reqLevel < 80) {
			 * stats.add(new Pair<>(EnchantFlag.Wdef, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("100% 방어력 주문서", usejuhun[0], stats)); stats.clear(); if
			 * (ii.getReqJob(equip.getItemId()) == 2) { stats.add(new
			 * Pair<>(EnchantFlag.Matk, Integer.valueOf(1))); ess.add(new
			 * EquipmentScroll("70% 마력 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Matk, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("30% 마력 주문서", usejuhun[2], stats)); stats.clear(); } else {
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(1))); ess.add(new
			 * EquipmentScroll("70% 공격력 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("30% 공격력 주문서", usejuhun[2], stats)); stats.clear(); } } else
			 * if (ii.getReqJob(equip.getItemId()) == 2) { stats.add(new
			 * Pair<>(EnchantFlag.Matk, Integer.valueOf(1))); ess.add(new
			 * EquipmentScroll("100% 마력 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Matk, Integer.valueOf(1))); ess.add(new
			 * EquipmentScroll("70% 마력 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Matk, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("30% 마력 주문서", usejuhun[2], stats)); stats.clear(); } else {
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(1))); ess.add(new
			 * EquipmentScroll("100% 공격력 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("70% 공격력 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Watk, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("30% 공격력 주문서", usejuhun[2], stats)); stats.clear(); } } else
			 * if (equip.getItemId() / 10000 == 111 || equip.getItemId() / 10000 == 112 ||
			 * equip.getItemId() / 10000 == 113 || equip.getItemId() / 10000 == 103) { if
			 * (reqLevel < 80) { stats.add(new Pair<>(EnchantFlag.Str, Integer.valueOf(1)));
			 * ess.add(new EquipmentScroll("100% 힘 주문서", usejuhun[0], stats));
			 * stats.clear(); stats.add(new Pair<>(EnchantFlag.Str, Integer.valueOf(2)));
			 * ess.add(new EquipmentScroll("70% 힘 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Str, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("30% 힘 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Dex, Integer.valueOf(1))); ess.add(new
			 * EquipmentScroll("100% 민첩 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Dex, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("70% 민첩 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Dex, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("30% 민첩 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Int, Integer.valueOf(1))); ess.add(new
			 * EquipmentScroll("100% 지력 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Int, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("70% 지력 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Int, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("30% 지력 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Luk, Integer.valueOf(1))); ess.add(new
			 * EquipmentScroll("100% 행운 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Luk, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("70% 행운 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Luk, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("30% 행운 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Hp, Integer.valueOf(50))); ess.add(new
			 * EquipmentScroll("100% 체력 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Hp, Integer.valueOf(100))); ess.add(new
			 * EquipmentScroll("70% 체력 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Hp, Integer.valueOf(150))); ess.add(new
			 * EquipmentScroll("30% 체력 주문서", usejuhun[2], stats)); stats.clear(); } else if
			 * (reqLevel < 120) { stats.add(new Pair<>(EnchantFlag.Str,
			 * Integer.valueOf(1))); ess.add(new EquipmentScroll("100% 힘 주문서", usejuhun[0],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Str,
			 * Integer.valueOf(2))); ess.add(new EquipmentScroll("70% 힘 주문서", usejuhun[1],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Str,
			 * Integer.valueOf(4))); ess.add(new EquipmentScroll("30% 힘 주문서", usejuhun[2],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Dex,
			 * Integer.valueOf(1))); ess.add(new EquipmentScroll("100% 민첩 주문서", usejuhun[0],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Dex,
			 * Integer.valueOf(2))); ess.add(new EquipmentScroll("70% 민첩 주문서", usejuhun[1],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Dex,
			 * Integer.valueOf(4))); ess.add(new EquipmentScroll("30% 민첩 주문서", usejuhun[2],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Int,
			 * Integer.valueOf(1))); ess.add(new EquipmentScroll("100% 지력 주문서", usejuhun[0],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Int,
			 * Integer.valueOf(2))); ess.add(new EquipmentScroll("70% 지력 주문서", usejuhun[1],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Int,
			 * Integer.valueOf(4))); ess.add(new EquipmentScroll("30% 지력 주문서", usejuhun[2],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Luk,
			 * Integer.valueOf(1))); ess.add(new EquipmentScroll("100% 행운 주문서", usejuhun[0],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Luk,
			 * Integer.valueOf(2))); ess.add(new EquipmentScroll("70% 행운 주문서", usejuhun[1],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Luk,
			 * Integer.valueOf(4))); ess.add(new EquipmentScroll("30% 행운 주문서", usejuhun[2],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(50))); ess.add(new EquipmentScroll("100% 체력 주문서",
			 * usejuhun[0], stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(100))); ess.add(new EquipmentScroll("70% 체력 주문서",
			 * usejuhun[1], stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(200))); ess.add(new EquipmentScroll("30% 체력 주문서",
			 * usejuhun[2], stats)); stats.clear(); } else { stats.add(new
			 * Pair<>(EnchantFlag.Str, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("100% 힘 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Str, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("70% 힘 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Str, Integer.valueOf(5))); ess.add(new
			 * EquipmentScroll("30% 힘 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Dex, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("100% 민첩 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Dex, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("70% 민첩 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Dex, Integer.valueOf(5))); ess.add(new
			 * EquipmentScroll("30% 민첩 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Int, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("100% 지력 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Int, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("70% 지력 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Int, Integer.valueOf(5))); ess.add(new
			 * EquipmentScroll("30% 지력 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Luk, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("100% 행운 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Luk, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("70% 행운 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Luk, Integer.valueOf(5))); ess.add(new
			 * EquipmentScroll("30% 행운 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Hp, Integer.valueOf(100))); ess.add(new
			 * EquipmentScroll("100% 체력 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Hp, Integer.valueOf(150))); ess.add(new
			 * EquipmentScroll("70% 체력 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Hp, Integer.valueOf(250))); ess.add(new
			 * EquipmentScroll("30% 체력 주문서", usejuhun[2], stats)); stats.clear(); } } else
			 * if (reqLevel < 80) { stats.add(new Pair<>(EnchantFlag.Str,
			 * Integer.valueOf(1))); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(5))); stats.add(new Pair<>(EnchantFlag.Wdef,
			 * Integer.valueOf(1))); ess.add(new EquipmentScroll("100% 힘 주문서", usejuhun[0],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Str,
			 * Integer.valueOf(2))); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(15))); stats.add(new Pair<>(EnchantFlag.Wdef,
			 * Integer.valueOf(2))); ess.add(new EquipmentScroll("70% 힘 주문서", usejuhun[1],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Str,
			 * Integer.valueOf(3))); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(30))); stats.add(new Pair<>(EnchantFlag.Wdef,
			 * Integer.valueOf(3))); ess.add(new EquipmentScroll("30% 힘 주문서", usejuhun[2],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Dex,
			 * Integer.valueOf(1))); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(5))); stats.add(new Pair<>(EnchantFlag.Wdef,
			 * Integer.valueOf(1))); ess.add(new EquipmentScroll("100% 민첩 주문서", usejuhun[0],
			 ...
			 * Integer.valueOf(3))); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(30))); stats.add(new Pair<>(EnchantFlag.Wdef,
			 * Integer.valueOf(3))); ess.add(new EquipmentScroll("30% 민첩 주문서", usejuhun[2],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Int,
			 * Integer.valueOf(1))); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(5))); stats.add(new Pair<>(EnchantFlag.Wdef,
			 * Integer.valueOf(1))); ess.add(new EquipmentScroll("100% 지력 주문서", usejuhun[0],
			 ...
			 * Integer.valueOf(3))); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(30))); stats.add(new Pair<>(EnchantFlag.Wdef,
			 * Integer.valueOf(3))); ess.add(new EquipmentScroll("30% 지력 주문서", usejuhun[2],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Luk,
			 * Integer.valueOf(1))); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(5))); stats.add(new Pair<>(EnchantFlag.Wdef,
			 * Integer.valueOf(1))); ess.add(new EquipmentScroll("100% 행운 주문서", usejuhun[0],
			 ...
			 * Integer.valueOf(3))); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(30))); stats.add(new Pair<>(EnchantFlag.Wdef,
			 * Integer.valueOf(3))); ess.add(new EquipmentScroll("30% 행운 주문서", usejuhun[2],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(55))); stats.add(new Pair<>(EnchantFlag.Wdef,
			 * Integer.valueOf(1))); ess.add(new EquipmentScroll("100% 체력 주문서", usejuhun[0],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(115))); stats.add(new Pair<>(EnchantFlag.Wdef,
			 * Integer.valueOf(2))); ess.add(new EquipmentScroll("70% 체력 주문서", usejuhun[1],
			 * stats)); stats.clear(); stats.add(new Pair<>(EnchantFlag.Hp,
			 * Integer.valueOf(180))); stats.add(new Pair<>(EnchantFlag.Wdef,
			 * Integer.valueOf(3))); ess.add(new EquipmentScroll("30% 체력 주문서", usejuhun[2],
			 * stats)); stats.clear(); } else if (reqLevel < 120) { stats.add(new
			 * Pair<>(EnchantFlag.Str, Integer.valueOf(2))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(20))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("100% 힘 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Str, Integer.valueOf(3))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(40))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(4))); ess.add(new
			 * EquipmentScroll("70% 힘 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Str, Integer.valueOf(5))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(70))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(7))); ess.add(new
			 * EquipmentScroll("30% 힘 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Dex, Integer.valueOf(2))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(20))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("100% 민첩 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Dex, Integer.valueOf(3))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(40))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(4))); ess.add(new
			 * EquipmentScroll("70% 민첩 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Dex, Integer.valueOf(5))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(70))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(7))); ess.add(new
			 * EquipmentScroll("30% 민첩 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Int, Integer.valueOf(2))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(20))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("100% 지력 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Int, Integer.valueOf(3))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(40))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(4))); ess.add(new
			 * EquipmentScroll("70% 지력 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Int, Integer.valueOf(5))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(70))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(7))); ess.add(new
			 * EquipmentScroll("30% 지력 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Luk, Integer.valueOf(2))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(20))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("100% 행운 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Luk, Integer.valueOf(3))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(40))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(4))); ess.add(new
			 * EquipmentScroll("70% 행운 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Luk, Integer.valueOf(5))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(70))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(7))); ess.add(new
			 * EquipmentScroll("30% 행운 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Hp, Integer.valueOf(120))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(2))); ess.add(new
			 * EquipmentScroll("100% 체력 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Hp, Integer.valueOf(190))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(4))); ess.add(new
			 * EquipmentScroll("70% 체력 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Hp, Integer.valueOf(320))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(7))); ess.add(new
			 * EquipmentScroll("30% 체력 주문서", usejuhun[2], stats)); stats.clear(); } else {
			 * stats.add(new Pair<>(EnchantFlag.Str, Integer.valueOf(3))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(30))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("100% 힘 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Str, Integer.valueOf(4))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(70))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(5))); ess.add(new
			 * EquipmentScroll("70% 힘 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Str, Integer.valueOf(7))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(120))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(10))); ess.add(new
			 * EquipmentScroll("30% 힘 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Dex, Integer.valueOf(3))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(30))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("100% 민첩 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Dex, Integer.valueOf(4))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(70))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(5))); ess.add(new
			 * EquipmentScroll("70% 민첩 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Dex, Integer.valueOf(7))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(120))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(10))); ess.add(new
			 * EquipmentScroll("30% 민첩 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Int, Integer.valueOf(3))); stats.add(new
			 ...
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("100% 지력 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Int, Integer.valueOf(4))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(70))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(5))); ess.add(new
			 * EquipmentScroll("70% 지력 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Int, Integer.valueOf(7))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(120))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(10))); ess.add(new
			 * EquipmentScroll("30% 지력 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Luk, Integer.valueOf(3))); stats.add(new
			 ...
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("100% 행운 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Luk, Integer.valueOf(4))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(70))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(5))); ess.add(new
			 * EquipmentScroll("70% 행운 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Luk, Integer.valueOf(7))); stats.add(new
			 * Pair<>(EnchantFlag.Hp, Integer.valueOf(120))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(10))); ess.add(new
			 * EquipmentScroll("30% 행운 주문서", usejuhun[2], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Hp, Integer.valueOf(180))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(3))); ess.add(new
			 * EquipmentScroll("100% 체력 주문서", usejuhun[0], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Hp, Integer.valueOf(270))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(5))); ess.add(new
			 * EquipmentScroll("70% 체력 주문서", usejuhun[1], stats)); stats.clear();
			 * stats.add(new Pair<>(EnchantFlag.Hp, Integer.valueOf(470))); stats.add(new
			 * Pair<>(EnchantFlag.Wdef, Integer.valueOf(10))); ess.add(new
			 * EquipmentScroll("30% 체력 주문서", usejuhun[2], stats)); stats.clear(); }
			 */
		}
		/*
		 * ess.add(new EquipmentScroll("이노센트 주문서 30%", 5000, stats)); ess.add(new
		 * EquipmentScroll("아크 이노센트 주문서 30%", 10000, stats)); if
		 * (equip.getViciousHammer() == 0) { if (equip.getUpgradeSlots() <
		 * ii.getSlots(equip.getItemId())) { ess.add(new EquipmentScroll("순백의 주문서 5%",
		 * 3000, stats)); } } else if (equip.getUpgradeSlots() <
		 * ii.getSlots(equip.getItemId()) + 1) { ess.add(new
		 * EquipmentScroll("순백의 주문서 5%", 3000, stats)); }
		 */
		return ess;
	}
	...
	public static StarForceStats starForceStats(Equip item) {
		...
		if (((Boolean) (ii.isSuperial(item.getItemId())).right).booleanValue()) {
			...
			if (item.getItemId() / 10000 == 108) {
				if (item.getEnhance() == 6 || item.getEnhance() == 8 || item.getEnhance() == 10
						|| item.getEnhance() >= 12) {
					if (ii.getReqJob(item.getItemId()) == 2) {
						stats.add(new Pair<>(EnchantFlag.Matk, Integer.valueOf(1)));
					} else {
			...
			if (GameConstants.isWeapon(item.getItemId())) {
				if (reqLevel < 140) {
					...
					case 15:
						stats.add(new Pair<>(isMagicWeapon(weaponType) ? EnchantFlag.Matk : EnchantFlag.Watk,
								Integer.valueOf(6)));
						break;
					case 16:
						stats.add(new Pair<>(isMagicWeapon(weaponType) ? EnchantFlag.Matk : EnchantFlag.Watk,
	...
	public static void handleEnchant(LittleEndianAccessor slea, MapleClient c) {
		...
		case 0:
			...
			if (GameConstants.isZeroWeapon(item.getItemId())) {
				equip1 = (Equip) c.getPlayer().getInventory(MapleInventoryType.EQUIPPED)
						.getItem((short) ((pos == -11) ? -10 : -11));
			}
			...
			if (i > 0) {
				if (scrollType(es.getName()) == 4) {
					Equip origin = (Equip) MapleItemInformationProvider.getInstance().getEquipById(item.getItemId(),
							false);
					...
					if (es.getName().contains("아크")) {
						for (int k = 0; k < equip3.getEnhance(); k++) {
							...
							for (Pair<EnchantFlag, Integer> stat : starForceStats.getStats()) {
								if (EnchantFlag.Watk.check(((EnchantFlag) stat.left).getValue())) {
									item.setEnchantWatk(
											(short) (item.getEnchantWatk() + ((Integer) stat.right).intValue()));
									if (equip1 != null) {
										equip1.setEnchantWatk(
												(short) (equip1.getEnchantWatk() + ((Integer) stat.right).intValue()));
									}
								}
								if (EnchantFlag.Matk.check(((EnchantFlag) stat.left).getValue())) {
									item.setEnchantMatk(
											(short) (item.getEnchantMatk() + ((Integer) stat.right).intValue()));
									if (equip1 != null) {
										equip1.setEnchantMatk(
												(short) (equip1.getEnchantMatk() + ((Integer) stat.right).intValue()));
									}
								}
								if (EnchantFlag.Str.check(((EnchantFlag) stat.left).getValue())) {
									item.setEnchantStr(
											(short) (item.getEnchantStr() + ((Integer) stat.right).intValue()));
									if (equip1 != null) {
										equip1.setEnchantStr(
												(short) (equip1.getEnchantStr() + ((Integer) stat.right).intValue()));
									}
								}
								if (EnchantFlag.Dex.check(((EnchantFlag) stat.left).getValue())) {
									item.setEnchantDex(
											(short) (item.getEnchantDex() + ((Integer) stat.right).intValue()));
									if (equip1 != null) {
										equip1.setEnchantDex(
												(short) (equip1.getEnchantDex() + ((Integer) stat.right).intValue()));
									}
								}
								if (EnchantFlag.Int.check(((EnchantFlag) stat.left).getValue())) {
									item.setEnchantInt(
											(short) (item.getEnchantInt() + ((Integer) stat.right).intValue()));
									if (equip1 != null) {
										equip1.setEnchantInt(
												(short) (equip1.getEnchantInt() + ((Integer) stat.right).intValue()));
									}
								}
								if (EnchantFlag.Luk.check(((EnchantFlag) stat.left).getValue())) {
									item.setEnchantLuk(
											(short) (item.getEnchantLuk() + ((Integer) stat.right).intValue()));
									if (equip1 != null) {
										equip1.setEnchantLuk(
												(short) (equip1.getEnchantLuk() + ((Integer) stat.right).intValue()));
									}
								}
								if (EnchantFlag.Wdef.check(((EnchantFlag) stat.left).getValue())) {
									item.setEnchantWdef(
											(short) (item.getEnchantWdef() + ((Integer) stat.right).intValue()));
									if (equip1 != null) {
										equip1.setEnchantWdef(
												(short) (equip1.getEnchantWdef() + ((Integer) stat.right).intValue()));
									}
								}
								if (EnchantFlag.Mdef.check(((EnchantFlag) stat.left).getValue())) {
									item.setEnchantMdef(
											(short) (item.getEnchantMdef() + ((Integer) stat.right).intValue()));
									if (equip1 != null) {
										equip1.setEnchantMdef(
												(short) (equip1.getEnchantMdef() + ((Integer) stat.right).intValue()));
									}
								}
								if (EnchantFlag.Hp.check(((EnchantFlag) stat.left).getValue())) {
									item.setEnchantHp(
											(short) (item.getEnchantHp() + ((Integer) stat.right).intValue()));
									if (equip1 != null) {
										equip1.setEnchantHp(
												(short) (equip1.getEnchantHp() + ((Integer) stat.right).intValue()));
									}
								}
								if (EnchantFlag.Mp.check(((EnchantFlag) stat.left).getValue())) {
									item.setEnchantMp(
											(short) (item.getEnchantMp() + ((Integer) stat.right).intValue()));
									if (equip1 != null) {
										equip1.setEnchantMp(
												(short) (equip1.getEnchantMp() + ((Integer) stat.right).intValue()));
									}
								}
								if (EnchantFlag.Acc.check(((EnchantFlag) stat.left).getValue())) {
									item.setEnchantAcc(
											(short) (item.getEnchantAcc() + ((Integer) stat.right).intValue()));
									if (equip1 != null) {
										equip1.setEnchantAcc(
												(short) (equip1.getEnchantAcc() + ((Integer) stat.right).intValue()));
									}
								}
								if (EnchantFlag.Avoid.check(((EnchantFlag) stat.left).getValue())) {
									item.setEnchantAvoid(
											(short) (item.getEnchantAvoid() + ((Integer) stat.right).intValue()));
									if (equip1 != null) {
										equip1.setEnchantAvoid(
												(short) (equip1.getEnchantAvoid() + ((Integer) stat.right).intValue()));
									}
								}
							}
						}
					...
					c.getSession()
							.writeAndFlush(CWvsContext.equipmentEnchantResult(50, item, null, null, null, new int[0]));
				} else {
					...
					if (EnchantFlag.Watk.check(es.getFlag())) {
						item.setWatk(
								(short) (item.getWatk() + ((Integer) (es.getFlag(EnchantFlag.Watk)).right).intValue()));
						if (equip1 != null) {
							equip1.setWatk((short) (equip1.getWatk()
									+ ((Integer) (es.getFlag(EnchantFlag.Watk)).right).intValue()));
						}
					}
					if (EnchantFlag.Matk.check(es.getFlag())) {
						item.setMatk(
								(short) (item.getMatk() + ((Integer) (es.getFlag(EnchantFlag.Matk)).right).intValue()));
						if (equip1 != null) {
							equip1.setMatk((short) (equip1.getMatk()
									+ ((Integer) (es.getFlag(EnchantFlag.Matk)).right).intValue()));
						}
					}
					if (EnchantFlag.Str.check(es.getFlag())) {
						item.setStr(
								(short) (item.getStr() + ((Integer) (es.getFlag(EnchantFlag.Str)).right).intValue()));
						if (equip1 != null) {
							equip1.setStr((short) (equip1.getStr()
									+ ((Integer) (es.getFlag(EnchantFlag.Str)).right).intValue()));
						}
					}
					if (EnchantFlag.Dex.check(es.getFlag())) {
						item.setDex(
								(short) (item.getDex() + ((Integer) (es.getFlag(EnchantFlag.Dex)).right).intValue()));
						if (equip1 != null) {
							equip1.setDex((short) (equip1.getDex()
									+ ((Integer) (es.getFlag(EnchantFlag.Dex)).right).intValue()));
						}
					}
					if (EnchantFlag.Int.check(es.getFlag())) {
						item.setInt(
								(short) (item.getInt() + ((Integer) (es.getFlag(EnchantFlag.Int)).right).intValue()));
						if (equip1 != null) {
							equip1.setInt((short) (equip1.getInt()
									+ ((Integer) (es.getFlag(EnchantFlag.Int)).right).intValue()));
						}
					}
					if (EnchantFlag.Luk.check(es.getFlag())) {
						item.setLuk(
								(short) (item.getLuk() + ((Integer) (es.getFlag(EnchantFlag.Luk)).right).intValue()));
						if (equip1 != null) {
							equip1.setLuk((short) (equip1.getLuk()
									+ ((Integer) (es.getFlag(EnchantFlag.Luk)).right).intValue()));
						}
					}
					if (EnchantFlag.Wdef.check(es.getFlag())) {
						item.setWdef(
								(short) (item.getWdef() + ((Integer) (es.getFlag(EnchantFlag.Wdef)).right).intValue()));
						if (equip1 != null) {
							equip1.setWdef((short) (equip1.getWdef()
									+ ((Integer) (es.getFlag(EnchantFlag.Wdef)).right).intValue()));
						}
					}
					if (EnchantFlag.Mdef.check(es.getFlag())) {
						item.setMdef(
								(short) (item.getMdef() + ((Integer) (es.getFlag(EnchantFlag.Mdef)).right).intValue()));
						if (equip1 != null) {
							equip1.setMdef((short) (equip1.getMdef()
									+ ((Integer) (es.getFlag(EnchantFlag.Mdef)).right).intValue()));
						}
					}
					if (EnchantFlag.Hp.check(es.getFlag())) {
						item.setHp((short) (item.getHp() + ((Integer) (es.getFlag(EnchantFlag.Hp)).right).intValue()));
						if (equip1 != null) {
							equip1.setHp((short) (equip1.getHp()
									+ ((Integer) (es.getFlag(EnchantFlag.Hp)).right).intValue()));
						}
					}
					if (EnchantFlag.Mp.check(es.getFlag())) {
						item.setMp((short) (item.getMp() + ((Integer) (es.getFlag(EnchantFlag.Mp)).right).intValue()));
						if (equip1 != null) {
							equip1.setMp((short) (equip1.getMp()
									+ ((Integer) (es.getFlag(EnchantFlag.Mp)).right).intValue()));
						}
					}
					if (EnchantFlag.Acc.check(es.getFlag())) {
						item.setAcc(
								(short) (item.getAcc() + ((Integer) (es.getFlag(EnchantFlag.Acc)).right).intValue()));
						if (equip1 != null) {
							equip1.setAcc((short) (equip1.getAcc()
									+ ((Integer) (es.getFlag(EnchantFlag.Acc)).right).intValue()));
						}
					}
					if (EnchantFlag.Avoid.check(es.getFlag())) {
						item.setAvoid((short) (item.getAvoid()
								+ ((Integer) (es.getFlag(EnchantFlag.Avoid)).right).intValue()));
						if (equip1 != null) {
							equip1.setAvoid((short) (equip1.getAvoid()
									+ ((Integer) (es.getFlag(EnchantFlag.Avoid)).right).intValue()));
						}
					}
					if (!GameConstants.isWeapon(item.getItemId()) && item.getItemId() / 10000 != 108
							&& item.getLevel() == 4) {
						if (ii.getReqJob(item.getItemId()) == 2) {
			...
			c.getSession()
					.writeAndFlush(CWvsContext.equipmentEnchantResult(100, equip3, item, es, null, new int[] { i }));
			c.getSession().writeAndFlush(
					CWvsContext.InventoryPacket.updateInventoryItem(false, MapleInventoryType.EQUIP, item));
			if (equip1 != null) {
				c.getSession().writeAndFlush(
						CWvsContext.InventoryPacket.updateInventoryItem(false, MapleInventoryType.EQUIP, equip1));
			}
			break;
		case 1:
			slea.skip(4);
			...
			item2 = null;
			if (GameConstants.isZeroWeapon(item.getItemId())) {
				item2 = (Equip) c.getPlayer().getInventory(MapleInventoryType.EQUIPPED)
						.getItem((short) ((pos == -11) ? -10 : -11));
			}
			...
			if (Randomizer.nextInt(1000) < i) {
				...
				for (Pair<EnchantFlag, Integer> stat : starForceStats.getStats()) {
					if (EnchantFlag.Watk.check(((EnchantFlag) stat.left).getValue())) {
						...
						if (item2 != null) {
							item2.setStarforceWatk(
									(short) (item2.getStarforceWatk() + ((Integer) stat.right).intValue()));
						}
					}
					if (EnchantFlag.Matk.check(((EnchantFlag) stat.left).getValue())) {
						item.setStarforceMatk((short) (item.getStarforceMatk() + ((Integer) stat.right).intValue()));
						if (item2 != null) {
							item2.setStarforceMatk(
									(short) (item2.getStarforceMatk() + ((Integer) stat.right).intValue()));
						}
					}
					if (EnchantFlag.Str.check(((EnchantFlag) stat.left).getValue())) {
						item.setStarforceStr((short) (item.getStarforceStr() + ((Integer) stat.right).intValue()));
						if (item2 != null) {
							item2.setStarforceStr(
									(short) (item2.getStarforceStr() + ((Integer) stat.right).intValue()));
						}
					}
					if (EnchantFlag.Dex.check(((EnchantFlag) stat.left).getValue())) {
						item.setStarforceDex((short) (item.getStarforceDex() + ((Integer) stat.right).intValue()));
						if (item2 != null) {
							item2.setStarforceDex(
									(short) (item2.getStarforceDex() + ((Integer) stat.right).intValue()));
						}
					}
					if (EnchantFlag.Int.check(((EnchantFlag) stat.left).getValue())) {
						item.setStarforceInt((short) (item.getStarforceInt() + ((Integer) stat.right).intValue()));
						if (item2 != null) {
							item2.setStarforceInt(
									(short) (item2.getStarforceInt() + ((Integer) stat.right).intValue()));
						}
					}
					if (EnchantFlag.Luk.check(((EnchantFlag) stat.left).getValue())) {
						item.setStarforceLuk((short) (item.getStarforceLuk() + ((Integer) stat.right).intValue()));
						if (item2 != null) {
							item2.setStarforceLuk(
									(short) (item2.getStarforceLuk() + ((Integer) stat.right).intValue()));
						}
					}
				}
				if ((item.getEnchantBuff() & 0x20) != 0) {
				...
				result = 2;
				while (item
						.getEnhance() > (((Boolean) (ii.isSuperial(item.getItemId())).right).booleanValue() ? 0 : 12)) {
					item.setEnhance((byte) (item.getEnhance() - 1));
					if (item2 != null) {
						item2.setEnhance((byte) (item2.getEnhance() - 1));
					}
					...
					for (Pair<EnchantFlag, Integer> stat : starForceStats.getStats()) {
						if (EnchantFlag.Watk.check(((EnchantFlag) stat.left).getValue())) {
							item.setStarforceWatk(
									(short) (item.getStarforceWatk() - ((Integer) stat.right).intValue()));
							if (item2 != null) {
								item2.setStarforceWatk(
										(short) (item2.getStarforceWatk() - ((Integer) stat.right).intValue()));
							}
						...
						if (EnchantFlag.Matk.check(((EnchantFlag) stat.left).getValue())) {
							item.setStarforceMatk(
									(short) (item.getStarforceMatk() - ((Integer) stat.right).intValue()));
							if (item2 != null) {
								item2.setStarforceMatk(
										(short) (item2.getStarforceMatk() - ((Integer) stat.right).intValue()));
							}
			...
			} else if ((((Boolean) (ii.isSuperial(item.getItemId())).right).booleanValue() || item.getEnhance() > 10)
					&& item.getEnhance() % 5 != 0) {
				result = 0;
				item.setEnhance((byte) (item.getEnhance() - 1));
				if (item2 != null) {
			...
			if (item.getEnchantBuff() >= 136 && item.getPosition() < 0) {
				MapleInventoryManipulator.unequip(c, item.getPosition(),
						c.getPlayer().getInventory(MapleInventoryType.EQUIP).getNextFreeSlot(),
						MapleInventoryType.EQUIP);
				if (item2 != null) {
					MapleInventoryManipulator.unequip(c, item2.getPosition(),
							c.getPlayer().getInventory(MapleInventoryType.EQUIP).getNextFreeSlot(),
							MapleInventoryType.EQUIP);
			...
			c.getSession().writeAndFlush(
					CWvsContext.equipmentEnchantResult(101, equip2, item, null, null, new int[] { result }));
			c.getSession().writeAndFlush(
					CWvsContext.InventoryPacket.updateInventoryItem(false, MapleInventoryType.EQUIP, item));
			if (item2 != null) {
				c.getSession().writeAndFlush(
						CWvsContext.InventoryPacket.updateInventoryItem(false, MapleInventoryType.EQUIP, item2));
			}
			break;
		case 2:
			slea.skip(4);
			...
			c.getSession().writeAndFlush(
					CWvsContext.equipmentEnchantResult(101, ordinary, trace, null, null, new int[] { 1 }));
			c.getSession().writeAndFlush(
					CWvsContext.InventoryPacket.updateInventoryItem(false, MapleInventoryType.EQUIP, trace));
		...
		case 52: // 스타포스
			...
			if ((!((Boolean) (ii.isSuperial(item.getItemId())).right).booleanValue() && item.getEnhance() <= 10)
					|| item.getEnhance() % 5 == 0) {
				down = 0;
			}
			if ((item.getEnchantBuff() & 0x20) != 0) {
			...
			if (c.getPlayer().getInventory(MapleInventoryType.EQUIP)
					.getNumFreeSlot() < (GameConstants.isZeroWeapon(item.getItemId()) ? 2 : 1)) {
				c.getPlayer().dropMessage(1,
						"裝備欄需要至少 " + (GameConstants.isZeroWeapon(item.getItemId()) ? 2 : 1) + "格空間.");
				return;
			}
			despoer = 0;
			...
			c.getSession().writeAndFlush(CWvsContext.equipmentEnchantResult(type, item, null, null, stats,
					new int[] { down, despoer, success, meso }));
			break;
		case 53:
			c.getSession().writeAndFlush(
					CWvsContext.equipmentEnchantResult(53, null, null, null, null, new int[] { -1525457920 }));
			break;
		}
	}
