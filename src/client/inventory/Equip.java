...
public class Equip extends Item implements Serializable {
	...
	public int getExpPercentage() {
		if (this.getEquipLevel() < this.getBaseLevel()
	...
	public int getEquipLevel() {
		...
		int expz = this.getEquipExp();
		for (int i = levelz; i <= GameConstants.getMaxLevel(this.getItemId())
				&& expz >= GameConstants.getExpForLevel(i, this.getItemId()); expz -= GameConstants.getExpForLevel(i,
						this.getItemId()), ++i) {
			++levelz;
		}
	...
	public void resetRebirth(int reqLevel) {
		if (GameConstants.isRing(this.getItemId()) || this.getItemId() / 1000 == 1092 || this.getItemId() / 1000 == 1342
				|| this.getItemId() / 1000 == 1713 || this.getItemId() / 1000 == 1712 || this.getItemId() / 1000 == 1152
				|| this.getItemId() / 1000 == 1143 || this.getItemId() / 1000 == 1672
				|| GameConstants.isSecondaryWeapon(this.getItemId()) || this.getItemId() / 1000 == 1190
				|| this.getItemId() / 1000 == 1191 || this.getItemId() / 1000 == 1182 || this.getItemId() / 1000 == 1662
	...
	public long newRebirth(int reqLevel, int scrollId, boolean update) {
		if (GameConstants.isRing(this.getItemId()) || this.getItemId() / 1000 == 1092 || this.getItemId() / 1000 == 1342
				|| this.getItemId() / 1000 == 1713 || this.getItemId() / 1000 == 1712 || this.getItemId() / 1000 == 1152
				|| this.getItemId() / 1000 == 1142 || this.getItemId() / 1000 == 1143 || this.getItemId() / 1000 == 1672
				|| GameConstants.isSecondaryWeapon(this.getItemId()) || this.getItemId() / 1000 == 1190
				|| this.getItemId() / 1000 == 1191 || this.getItemId() / 1000 == 1182 || this.getItemId() / 1000 == 1662
				|| this.getItemId() / 1000 == 1802) {
			return 0L;
		...
		if (MapleItemInformationProvider.getInstance().getName(scrollId) != null) {
			...
			if (MapleItemInformationProvider.getInstance().getName(scrollId).contains("영원한 환생의")
					|| MapleItemInformationProvider.getInstance().getName(scrollId).contains("검은 환생의")) {
				maxValue = 7;
			}
		}
		Equip ordinary = (Equip) MapleItemInformationProvider.getInstance().getEquipById(this.getItemId(), false);
		...
		for (int i = 0; i < 4; ++i) {
			...
			while (rebirthOptions[0] == randomOption || rebirthOptions[1] == randomOption
					|| rebirthOptions[2] == randomOption || rebirthOptions[3] == randomOption || randomOption == 12
					|| randomOption == 14 || randomOption == 15 || randomOption == 16
					|| !GameConstants.isWeapon(this.getItemId()) && (randomOption == 21 || randomOption == 23)) {
				randomOption = Randomizer.nextInt(25);
			}
			rebirthOptions[i] = randomOption;
			int randomValue = 0;
			randomValue = (randomOption == 17 || randomOption == 18) && !GameConstants.isWeapon(this.getItemId())
					|| randomOption == 22 ? Randomizer.rand(1, maxValue) : Randomizer.rand(3, maxValue);
	...
	public void setZeroRebirth(MapleCharacter chr, int reqLevel, int scrollId) {
		...
		int maxValue = 5;
		if (MapleItemInformationProvider.getInstance().getName(scrollId) != null) {
			if (MapleItemInformationProvider.getInstance().getName(scrollId)
					.contains("\uac15\ub825\ud55c \ud658\uc0dd\uc758")) {
				maxValue = 6;
			}
			if (MapleItemInformationProvider.getInstance().getName(scrollId)
					.contains("\uc601\uc6d0\ud55c \ud658\uc0dd\uc758")
					|| MapleItemInformationProvider.getInstance().getName(scrollId)
							.contains("\uac80\uc740 \ud658\uc0dd\uc758")) {
				maxValue = 7;
			}
		}
