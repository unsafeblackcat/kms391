...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		var msg = "  #l\r\n";
		msg += "#L1##fc0xFFFF3636#" + 템버리기 + "[마을] 마을맵 이동하기    #l";
		msg += "#L2##fc0xFFFF3636#" + 템버리기 + "[사냥] 사냥터 이동하기#l\r\n";
        msg += "#L3##fc0xFFFF3636#" + 템버리기 + "[컨텐츠] 컨텐츠 이동하기 #l";
		msg += "#L4##fc0xFFFF3636#" + 템버리기 + "[길드] 길드맵 이동하기#l\r\n";
		...
		switch (ans_01) {
			...
			case 2:
				...
				break;
			case 3:
				selStr += "#L1# #fs11##e#d도박장 아케이드#l\r\n\r\n";
				selStr += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
				selStr += "#L2# #fs11##e#d루디브리엄 파티퀘스트#n #k이동\r\n";
				selStr += "#L3# #e#d독안개의숲 파티퀘스트#n #k이동#l\r\n\r\n";
				selStr += "#fc0xFFD5D5D5#───────────────────────────#k\r\n";
				selStr += "#L4# #fs11##e#d끈기의 숲#n #k이동\r\n";
				selStr += "#L5# #e#d인내의 숲#n #k이동\r\n";
				selStr += "#L6# #e#d고지를 향해서#n #k이동\r\n";
				selStr += "#L7# #e#d펫 산책로[헤네시스]#n #k이동\r\n";
				selStr += "#L8# #e#d펫 산책로[루디브리엄]#n #k이동\r\n";
				break;
			case 4:
				cm.dispose();
				cm.warp(200000301, 0);
