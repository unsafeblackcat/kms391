...
public abstract class MapleEvent {
	...
	public void onMapLoad(MapleCharacter chr) {
		if (!FieldLimitType.Event.check(chr.getMap().getFieldLimit())
	...
	public static final String scheduleEvent(MapleEventType event, ChannelServer cserv) {
		...
		World.Broadcast.broadcastMessage(CWvsContext.serverNotice(0, "",
				"Hello " + cserv.getServerName() + "! Let's play a " + StringUtil.makeEnumHumanReadable(event.name())
						+ " event in channel " + cserv.getChannel() + "! Change to channel " + cserv.getChannel()
