...
var SCRIPT_TITLE = "#fs15##e#b<一鍵轉生的火花>#n#k";
var enter = "\r\n";
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        chat += "#fs15##b楓葉故事方便一鍵星火系統" + enter;
        chat += "#fs15##r請選擇要使用的轉世之火。" + enter;
        ...
        if (selectedEquipment != null && selectedRebirthFireItemId != null) {
            if (checkCost(selectedRebirthFireItemId)) {
                ...
                chat += "#fs15##L" + SELECTION_APPLY + "#再次使用" + enter;
                chat += "#fs15##L" + SELECTION_EXIT + "#結束使用" + enter;
            } else {
