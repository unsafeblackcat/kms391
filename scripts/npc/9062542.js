...
function action(mode, type, selection) {
	...
	if (status == 0) {
		var msg = "강한 보스를 처치한 사람만 #r#e#i4310329:# #t4310329##n#k를 얻을 수 있네."+enter;
		...
		if (sel == 0) {
			...
			if (cm.getInfoQuest(123456, "").equals("")) {
				cm.sendOk("이번 주 자네가 처치한 보스는 없군!\r\n주간 보스를 처치하면 #r#e#i4310329:# #t4310329##n#k를 주겠네!");
				cm.dispose();
				return;
			}
		...
		if (sel == 2) {
			...
			cm.sendNext("#b#e네오 포스#n#k는 습득하면 #r#e2023년 4월 30일(수) 23시 59분#n#k까지 효과가 유지된다.\r\n그럼 강한 몬스터를 처치하고 찾아오도록!");
			cm.dispose();
		}
	} else if (status == 5) {
		if (sel == 3) {
			cm.sendNextPrev("그리고 #i4310329# #r#e#t4310329##n#k는 일주일에 #b#e월드 당 최대 400개#n#k까지만 만들 수 있다.\r\n\r\n#r ※ 네오 코어는 월드 내 공유되며, 월드 당 주간 400개까지 획득할 수 있습니다.");
		}
	} else if (status == 6) {
		if (sel == 3) {
			cm.sendNextPrev("당연한 말이지만 #b#e강한 몬스터#n#k일수록 더 많은 #r#e네오 코어#n#k를 만들 수 있다는 것도 알아두도록.\r\n#e\r\n\r\n#r#i4310329# #t4310329# 5개#k#e\r\n 하드 힐라#e\r\n 카오스 핑크빈#e\r\n 이지 시그너스#e\r\n 노멀 시그너스#e\r\n\r\n#r#i4310329# #t4310329# 10개#k#e\r\n 카오스 자쿰#e\r\n 카오스 피에르#e\r\n 카오스 반반#e\r\n 카오스 블러디퀸#e\r\n\r\n#r#i4310329# #t4310329# 20개#k#e\r\n 하드 매그너스#e\r\n 카오스 벨룸#e\r\n\r\n#r#i4310329# #t4310329# 30개#k#e\r\n 카오스 파풀라투스#e\r\n 노멀 스우#e\r\n 노멀 데미안#e\r\n 이지 루시드#e\r\n\r\n#r#i4310329# #t4310329# 40개#k#e\r\n 노멀 루시드#e\r\n 노멀 윌#e\r\n 노멀 더스크#e\r\n 노멀 듄켈#e\r\n\r\n#r#i4310329# #t4310329# 60개#k#e\r\n 하드 데미안 #e\r\n 하드 스우#e\r\n 하드 루시드#e\r\n 하드 윌#e\r\n\r\n#r#i43103298# #t4310329# 70개#k#e\r\n 카오스 더스크#e\r\n 하드 듄켈#e\r\n 진 힐라");
		}
	} else if (status == 6) {
		if (sel == 3) {
