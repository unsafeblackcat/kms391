...
bannedhair = [42960,42670,42830,42810,42820,42840,42850,42560,42530,42540,42550,42570,42600,42580,42590,42610,42620,42860,42920,42870,42910,42880,42890,42900,42630,42640,42650,42660,42930,42950,425951];
   ...
   if (status == 0) {
      var msg = "#fs15##fc0xFF000000#想咨詢什麽髮型 造型的名稱？\r\n\r\n";
      msg += "#L1##fUI/UIWindow4.img/pointShop/100658/iconShop##fc0xFF6600CC# 咨詢髮型#fc0xFF000000#相關.\r\n";
      msg += "#L2##fUI/UIWindow4.img/pointShop/100658/iconShop##fc0xFF990033# 咨詢面型#fc0xFF000000#相關.\r\n";
      msg += "#L3##fUI/UIWindow4.img/pointShop/100658/iconShop##fc0xFFFF3300# 咨詢膚色#fc0xFF000000#相關.#l\r\n";
     // msg += "#L7##fUI/UIWindow4.img/pointShop/100658/iconShop##fc0xFF009933# 치장 상점#fc0xFF000000#을 이용하겠습니다.#l\r\n\r\n";
      msg += "#Cgray##fs15#――――――――――――――――――――――――――――――――――――――――#fc0xFF000000#\r\n";
    //  msg += "#L4##fUI/UIWindow4.img/pointShop/100658/iconShop##fc0xFF006699# 기타 (해외캐시,성전환,RGB변경)#fc0xFF000000#를 이용하겠습니다.\r\n";
     // msg += "#L6##fUI/UIWindow4.img/pointShop/100658/iconShop##fc0xFF3300CC# 해외 헤어#fc0xFF000000#를 이용하겠습니다.\r\n";
      msg += "#L5##fUI/UIWindow4.img/pointShop/100658/iconShop##fc0xFF990066# 使用搜索#fc0xFF000000#功能.\r\n";
      cm.sendSimple(msg);

   } else if (status ==1) {
      codyList = [];
      gColor = !cm.getPlayer().getGender() ? "#fs15##d女性" : "#fs15##b男性";
      seld = selection;
      selStr = "";
      switch (seld) {
         case 1:
            selStr += "#e#r[更改角色髮型]#b#n\r\n";
            selStr += "#L1##fs15# 髮型師 A#l\r\n#L2# 髮型師 B#l\r\n";
            selStr += "#L3# 髮型師 C#l\r\n#L4# 髮型師 D#l \r\n#L5# 髮型師 E#l#k";
        if (cm.getPlayer().getAndroid() != null) {
                    
            selStr += "\r\n\r\n#e#r#fs15#[更改機器人髮型]#k#b#n\r\n";
            selStr += "#L12##fs15# 髮型師 A#l\r\n#L13# 髮型師 B#l\r\n";
            selStr += "#L14# 髮型師 C#l\r\n#L15# 髮型師 D (最新髮型)#l\r\n";
            selStr += "#L16# 髮型師 E#l";
         ...
         case 2:
            selStr += "#e#r[角色整形]#b#n\r\n";
            selStr += "#e #n#L6##fs15#整形清單 A#l\r\n#L7# 整形清單 B#l\r\n#b#L8# 整形清單 C#l\r\n";
        if (cm.getPlayer().getAndroid() != null) {
                    
                    selStr += "\r\n\r\n#e#r#fs15#[안드로이드 성형]#k#b#n\r\n#fs15#";
                    selStr += "#e #n#L16# 整形清單 A#l#L17# 整形清單 B #e#r(最新整形)#l\r\n";
        }
         break;
         case 3:
            selStr += "#e#r[頭髮染色]\r\n#n ※注意：鏡片顏色只能更改為 #b彩色鏡頭#r優惠券.#b#n\r\n";
            selStr += "#fs15##L40# 普通#n染色\r\n#l";
            selStr += "#L21# 混合#n染色\r\n#l";
            selStr += "#L9# 更改#n 膚色#l#k\r\n ";
        if (cm.getPlayer().getAndroid() != null) {
                    
                    selStr += "\r\n\r\n#e#r[機器人 染色]#b#n\r\n";
                    selStr += "#L19# #b#e機器人#n#b 普通#n染色\r\n#l";
                    selStr += "#L18# #b#e機器人#n#b 混合#n 染色\r\n#l";
                    selStr += "#L20# #b#e機器人#n#b 更改#n 膚色#l#b\r\n";
        }
         break;
         case 4:
            selStr += "#fs15##fc0xFF000000#去見見海外的凱西吧!#b#n\r\n";
            selStr += "#L10# "+gColor+"#n變性為#l#b\r\n\r\n";
            selStr += "#L23# 使用海外#n 商店#l\r\n";
            //selStr += "#L29# 스페셜 헤어#n 이용하기#l\r\n";
            //selStr += "#L98##fMap/MapHelper.img/minimap/party# 알쏭 달쏭 믹렌#n 이용하기#l\r\n";
            selStr += "#L988# 使用RGB #n 更改#l\r\n";
...
return;
        ...
        if(SEL_00 == 10)
        {
            ...
            {
                cm.sendOkS("零職業人群不能變性.", 4);
                cm.dispose();
                return;
            }
            cm.sendYesNoS("#e"+gColor+"#n#k是否要變性?不能再佩戴符合該性別的裝備.", 4);
        }

        Beauty = SEL_00 < 2 ? "#e헤어#n를" : SEL_00 == 2 ? "#e얼굴#n을" : "#e색깔#n을"; 
        selStr = "#fn提神##fc0xFFFFFFFF#現在的 "+Beauty+" 完全可以換成新的風格. 如果厭倦了現在的樣子，就慢慢考慮一下想換的髮型";
        switch(SEL_00)
        {
        ...
        cm.sendStyle(selStr, codyList);
            ...
            cm.sendGetNumber("#fs15#輸入想要更改的 #r顏色值#k即可\r\n現有顏色為 #d'0'#k 이야 (0 ~ 1000)", 0, 0, 1000);
        } else if(SEL_00 >= 12) {
