	...
	if (status == 0) {
		...
		switch (ans_01) {
			...
			case 4:
			    ...
			    selStr += "이동을 원하시면 개인맵 주인의 통행증이 필요합니다.\r\n어디로 이동하시겠어요?\r\n";
				selStr += "#L1##fs11# #e#d[ $ ] 의 마을#n #k이동\r\n";
				selStr += "#L2# #e#d[ $ ] 사냥터#n #k이동\r\n";
				selStr += "#L3# #e#d[예천주먹] 자동 사냥터#n #k이동\r\n";
