...
public class SecondAtom extends MapleMapObject {
	...
	public SecondAtom(int projectileType, int ownerId, int targetId, int skillId, int duration, int custom,
			int maxPerHit, Point point, List<Integer> points) {
	...
	public SecondAtom(int projectileType, int ownerId, int targetId, int delay, int skillId, int duration, int custom,
			int maxPerHit, Point point, List<Integer> points) {
		this.projectileType = projectileType;
		this.ownerId = ownerId;
		this.targetId = targetId;
	...
	public SecondAtom(int projectileType, int ownerId, int targetId, int delay, int skillId, int duration, int custom,
			int maxPerHit, Point point, List<Integer> points, int spawnType) {
		this.projectileType = projectileType;
		this.ownerId = ownerId;
		this.targetId = targetId;
		this.delay = delay;
	...
	public void sendSpawnData(MapleClient client) {
		client.getSession().writeAndFlush(
				CField.spawnSecondAtoms(this.ownerId, Arrays.asList(new SecondAtom[] { this }), this.spawnType));
	}
