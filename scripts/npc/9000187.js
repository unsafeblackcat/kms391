...
function action(mode, type, selection) {
    ...
    */
    ...
    if (status == 0) {
        ...
        말 = "#fc0xFF6600CC##e#fs15#[PRAY] 육성 다이어리#n#k\r\n\r\n";
        말 += "#b" + questlist.length + " 개#k 의 #b#e[PRAY] 육성 다이어리#k#n를 완성하고 보상을 받아가세요.\r\n#r#e#fs15#[ 퀘스트를 클릭하면 해당 맵으로 이동합니다. ]#k#fs15##n\r\n";
        ...
        for (i = 0; i < questlist.length; i++) {
            ...
            if (Integer.parseInt(cm.getPlayer().getKeyValue(20190710 + i, "diary")) != -1) {
                ...
                for (j = 0; j < rewardlist[i].length; j++)
                    말 += "#fs15#     #fc0xFFF781D8#ㄴ 보상 : #i" + rewardlist[i][j][0] + "# #b#z" + rewardlist[i][j][0] + "# " + rewardlist[i][j][1] + "개#k\r\n"
            }
        }
