...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        ...
        if (cm.getPlayer().getPPoint() < 0) {
            cm.getPlayer().setPPoint(0);
        }
        var msg = "#fs11# 안녕하세요. #ePRAY#n 패키지포인트 지급 도우미 입니다.\r\n " + enter;
        msg += "현재 #b#h ##k님의 패키지 포인트 : #b" + cm.getPlayer().getPPoint() + "P#k" + enter;
        msg += "현재 #b#h ##k님의 패키지 등급 : #b" + cm.getPlayer().getPgrades() + "#k#b" + enter;
        msg += "현재 #b#h ##k님의 누적 횟수 : #b" + cm.getPlayer().getClient().getKeyValue("PNumber") + "회#k#b" + enter + enter;
        //msg += "#L1#패키지포인트 수령하기" + enter;
        //msg += "#L2#패키지포인트 랭킹확인"+enter;
        msg += "#L5#패키지포인트 상점" + enter;
        msg += "#L7#누적 횟수 보상 수령하기"+enter;
        if (cm.getPlayer().isGM()) {
            msg += "#L3#패키지포인트 지급하기" + enter;
            msg += "#L4#패키지 유저 관리하기" + enter;
            msg += "#L6#누적 횟수 수정";
        }
        cm.sendSimple(msg);
    } else if (status == 1) {
        ...
        switch (sel) {
            ...
            case 4:
                ...
                msg += "#L2#유저의 패키지 등급 조정";
                cm.sendSimple(msg);
                break;
            case 5:
                /*				var msg = "구매하실 항목을 선택해주세요."+enter;
                				msg += "현재 #b#h ##k님의 패키지 포인트 : #b"+cm.getPlayer().getPPoint()+"P#k"+enter;
                				msg += "현재 #b#h ##k님의 패키지　 등급 : #b"+cm.getPlayer().getPgrades()+"#k"+enter
                ...
                /*
				var msg = "구매하실 항목을 선택해주세요."+enter;
				msg += "패키지 등급에 따라 구매 가능한 물품이 달라집니다." + enter;
				msg += "#h 0#님의 패키지 등급 : #b"+cm.getPlayer().getPgrades()+"#k#b"+enter;
				a = 0;
				for (i = 0; i < shop.length; i++) {
            ...
            case 7:
                ...
                var msg = "#b누적 패키지 " + NumReward[g]['n'] + "회#k를 달성하신 것을 축하합니다!" + enter;
                msg += "낮은 등급의 보상부터 차례차례 받게 됩니다." + enter;
                msg += "현재 받을 보상은 #b패키지 " + NumReward[g]['n'] + "회차, 단풍리 " + grade[g + 3][1] + " 등급#k의 보상입니다." + enter + enter;
        ...
        switch (seld) {
            ...
            case 3:
                ...
                cm.sendGetNumber(msg, 0, 0, 1000000);
                break;
            case 4:
                seld3 = sel;
                if (!cm.getPlayer().isGM())
            ...
            case 5:
                ...
                msg += "패키지 포인트 #r#e" + itx['price'] + "P#k#n만큼 차감됩니다.";
            ...
            case 6:
                ...
                var msg = "#b" + name + "#k의 패키지등급을 몇 회로 설정 하시겠습니까?" + enter;
                if (modifychr == null) {
            ...
            case 4:
                ...
                switch (seld3) {
                    case 2:
                        ...
                        var msg = "#b" + modify + "#k의 패키지등급을 어떤 것으로 변경하시겠습니까?" + enter;
                        if (modifychr == null)
                ...
                break;
            case 5:
                if (cm.getPlayer().getPPoint() < itx['price']) {
                    cm.sendOk("패키지포인트가 부족합니다.");
                    cm.dispose();
                    return;
                }
                ...
                cm.getPlayer().gainPPoint(-itx['price']);
                ...
                msg += "현재 #h 0#님의 남은 패키지포인트 : #e#b" + cm.getPlayer().getPPoint() + "P#k#n";
                cm.sendOk(msg);
                cm.dispose();
                break;
            case 6:
        ...
        switch (seld) {
            case 1:
                ...
                */
                ...
                cm.getPlayer().gainPPoint(reward);
                //cm.getPlayer().gainnPPoint(reward);
...
function getRanking(asd) {
    ...
    var con = DatabaseConnection.getConnection();
    var ps = con.prepareStatement("SELECT * FROM kms.acckeyvalue WHERE `key` = 'nPPoint' ORDER BY CAST(`value` AS UNSIGNED INT) DESC LIMIT " + asd);
    ...
    while (rs.next()) {
        ...
        ret += as + ". #b" + name + "#k 누적 패키지포인트 : #d" + rs.getString("value") + "#k\r\n";
    }
    rs.close();
    ps.close();
...
function getList() {
    ...
    if (ret.equals("")) return "#fs11#현재 수령 가능한 패키지 보상이 없습니다.";
    return ret;
}
...
function getQ(id) {
    ...
    rs.close();
    ps.close();
    if (ret.equals("")) return "패키지 보상이 없습니다.";
    return ret;
}
