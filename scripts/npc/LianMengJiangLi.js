...
function action(mode, type, selection) {
    ...
    choose += "#fc0xFFD5D5D5#──────────────────────────#k\r\n";
        choose += "#L12##fs15##fc0xFFDF4D4D#[聯盟]  6000 達成講勵（每個帳戶一次）#l\r\n";
        choose += "#L11##fc0xFFDF4D4D#[聯盟]  8000 達成講勵（每個帳戶一次）#l\r\n";
        choose += "#L30##fc0xFFDF4D4D#[聯盟] 10000 達成講勵（每個帳戶一次）#l\r\n";
    ...
    choose += "    ";
        ...
        if (selection == 100) { // 사냥이벤트 아이템교환
            ...
            if(cm.getPlayer().getAllUnion() < 8000) {
                cm.sendOk("#fs15#聯盟等級總和 [ #b8000#k ] 以上 [ #b角色#k ] 發放一次的 #r獎勵#k請滿足後來找我。");
                cm.dispose();
                return;
        ...
        cm.sendOk("#fs15#祝賀您達到 #rr8000等級#k 支付了!\r\n\r\n#b#i4319999# 1000個和10億金幣.");
