...
function action(mode, type, sel) {
	...
	if (status == 0) {
        ...
        msg += "#L1##fs15##d아이템 목록을 확인해본다."+enter;
		...
		switch (sel) {
			...
			case 2:
				...
				cm.sendOk("#fs15#다음과 같은 아이템이 나왔다. #fs15##b"+enter+"#i"+dskin[a]+"##z"+dskin[a]+"#");
				cm.dispose();
			break;
			case 3:
				var msg = "원하시는 데미지스킨을 선택해주세요. #fs15##b"+enter;
			...
			cm.gainItem(dskin[a], 1);
			cm.sendOk("다음과 같은 아이템이 나왔습니다! #fs15##b"+enter+"#i"+dskin[a]+"##z"+dskin[a]+"#");
			cm.dispose();
	}
}