...
function end(mode, type, selection) {
    ...
    if (status2 == 0) {
        qm.sendNextS("임무를 무사히 마치고 돌아오셨네요. 말씀드린대로 #i4310229# #b#z4310229# 80개#k를 보상으로 드릴게요 ", 0x04, 9010106);
    } else if (status2 == 1) {
        qm.getPlayer().AddAllUnionCoin(80);
