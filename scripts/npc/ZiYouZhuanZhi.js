...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        choose += "#L7##fc0xFFFF3636#自由轉職#l";
        choose += "#L8##fc0xFFFF3636#轉世加强#l\r\n\r\n";
        ...
        if (selection == 1) { // 아이템 버리기
         ...
         cm.openNpc(1105008);
            ...
            cm.dispose();
            cm.openNpcCustom(cm.getClient(), 1052206, "ZiYouZhuanZhi1");
        } else if (selection == 8) { //자유 전직
            cm.dispose();
            cm.openNpcCustom(cm.getClient(), 9062178, "ZhuanShiJiaQiang");
