...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        msg += "#L1004#[PRAY] 커스텀 제작\r\n\r\n#l"
        //msg += "#L1000##b[PRAY] 커스텀 1기 제작 \r\n\r\n#l"
        msg += "#L2001##b[PRAY] 커스텀 2기 제작 \r\n\r\n#l"
        //msg += "#L1004#[PRAY] 커스텀 3기 제작\r\n\r\n#l"
       // msg += "#L1001#칠요의 몬스터파커 훈장 제작\r\n#l"
        //msg += "#L1002#[PRAY] 칭호를 승급하고 싶어요.\r\n#l"
        msg += "#L2000#[PRAY] 커스텀 3기 제작\r\n\r\n"
        //msg += "#L1003#칠요의 뱃지 제작\r\n\r\n#l"
        //msg += "#L1005#커플링/우정링제작\r\n#l"
        ...
        if (selection == 0) {
            ...
            cm.dispose();
            cm.openNpc(1540859); //커스텀 1기
        } else if (selection == 1000) {
            cm.dispose();
            cm.openNpc(2120018); //장비승급
            ...
            cm.dispose();
            cm.openNpc(1530300); //커스텀 2기
        } else if (selection == 2001) {
            cm.dispose();
            cm.openNpc(2192032); //장비승급
        }
    } else if (status == 2) {
        sell = selection;
        if (sel == 4) { // 칭호 승급
