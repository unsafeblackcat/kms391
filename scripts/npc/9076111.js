...
+"파티장을 제외한 모든 파티원이 #b개별 미션을 클리어#k 하면 스테이지를 클리어 하게 됩니다. 그럼 행운을 빕니다.");
        ...
        if(cm.isLeader()){
            ...
            if (em.getProperty("stage5") == null) {
                ...
                talk +="#r(보상이 지급 됩니다.)#k\r\n\r\n";
                talk +=icon+"\r\n";
                talk +="#L0# #i4310237# #z4310237#를 받는다.\r\n";
                talk +="#L1# #i4310266# #z4310266#를 받는다.\r\n";
                talk +="#L2# #i4310010# #z4310010#를 받는다.\r\n";
                talk +="#L3# #i4001716# #z4001716#를 받는다.\r\n";
                talk +="#L4# #i4310175# #z4310175#를 받는다.\r\n";
                cm.sendSimple(talk);
            }
    }
	} else if(St == 1){
        ...
        } else if(cm.getPlayer().getMapId() == mapid[4]){ // 커닝파퀘 보상
            if(S == 0){
                cm.gainItem(4310237, 100);
                cm.gainItem(4310266, 50);
                cm.gainItem(4310010, 10);
                cm.gainItem(4001716, 2);
                cm.gainItem(4310175, 50);
                cm.warp(mapid[5]);
                cm.dispose();
            } else {
                cm.gainItem(4310237, 100);
