...
function act() {
	...
	if(re[m1].getState() == 1 && re[m2].getState() == 1 && re[m3].getState() == 1 && re[m4].getState() == 1 && re[m5].getState() == 1 && re[m6].getState() == 1){
		...
		rm.getMap().spawnMonsterOnGroundBelow(Packages.server.Luna.MapleLunaFactory.getMonster(9300902), new java.awt.Point(-194, -188));
		rm.getMap().spawnMonsterOnGroundBelow(Packages.server.Luna.MapleLunaFactory.getMonster(9300906), new java.awt.Point(-213, -192));
		//mobspawn();
		var tick = 0;
...
function mobspawn(){
	...
	for (var i = 0; i < 4; i++) {
			rm.getMap().spawnMonsterOnGroundBelow(Packages.server.Luna.MapleLunaFactory.getMonster(Mmobid[0]), new java.awt.Point(Mmobid1x[i], Mmobid1y[i]));
			rm.getMap().spawnMonsterOnGroundBelow(Packages.server.Luna.MapleLunaFactory.getMonster(Mmobid[1]), new java.awt.Point(Mmobid2x[i], Mmobid2y[i]));
			rm.getMap().spawnMonsterOnGroundBelow(Packages.server.Luna.MapleLunaFactory.getMonster(Mmobid[2]), new java.awt.Point(Mmobid3x[i], Mmobid3y[i]));
	}
}