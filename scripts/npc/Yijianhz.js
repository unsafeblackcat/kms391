...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        var msg ="#fs15#我可以爲沒有潛在能力的胸章物品賦予潛在能力 #fs15##b"+enter;
        msg += "#L1#胸章道具潛在能力賦予"+enter;
        ...
        贊助 = sel == 1 ? 胸章1 : sel == 2 ? 口袋1 : 現金1;
        推廣 = sel == 1 ? 胸章2 : sel == 2 ? 口袋2 : 現金2;
        msg += "#L1#贊助點 ("+贊助+"P)\r\n";
        msg += "#L2#推廣點 ("+推廣+"P)\r\n";
        cm.sendSimple(msg);
    } else if (status == 2) {
        ...
        pt = seld2 == 1 ? "贊助" : "推廣";
        need = (seld2 == 1 && seld == 1) ? 胸章1 : (seld2 == 1 && seld == 2) ? 口袋1 : (seld2 == 1 && seld == 3) ? 現金1 : (seld2 == 2 && seld == 1) ? 胸章2 : (seld2 == 2 && seld == 2) ? 口袋2 : 現金2;
        seldi = seld == 1 ? "胸章物品" : seld == 2 ? "口袋物品" : "现金道具";
        ic = seld == 1 ? 118 : 116;
